        REM CAELUSASSOCIATESSPOKANEWASHINGTONALLRIGHTSRESERVEDCAELUSASSOC~
            *                                                           *~
            *  H   H  N   N  Y   Y  M   M  V   V  M   M  TTTTT          *~
            *  H   H  NN  N  Y   Y  MM MM  V   V  MM MM    T            *~
            *  HHHHH  N N N   YYY   M M M  V   V  M M M    T            *~
            *  H   H  N  NN    Y    M   M   V V   M   M    T            *~
            *  H   H  N   N    Y    M   M    V    M   M    T            *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * HNYMVMT  - USER CONTROL OF WHAT IS RECORDED AS INVENTORY  *~
	    ...
	    * 06/06/96 ! Changes for the year 2000                ! DXL *~
            CAELUSASSOCIATESSPOKANEWASHINGTONALLRIGHTSRESERVEDCAELUSASSOC

            sub "HNYMVMT"  (part$,       /* PART CODE                  */~
...
ccyy_fmt:   FMT BI(2)
            readkey$ = str(part$,,25) & str(store$,,3) & ccyy$
...
L11090:     call "READ101" (#1, readkey$, f1%)
            ...
            write #1, using L11150, part$, store$, date%, zero$,  ~
                                   zero1$, month$(), " "
L11150:     FMT CH(25), CH(3), BI(2), CH(192), CH(192), 20*CH(1), CH(16)
            goto L11090

L11180:     get #1, using L11190, zero$, zero1$, month$()
L11190:         FMT POS(31), CH(192), CH(192), 20*CH(1)
