        REM CAELUSASSOCIATESSPOKANEWASHINGTONALLRIGHTSRESERVEDCAELUSASSOC~
            ...
            * 10/26/99 ! Change Transaction code IW to a withdwdal! CMG *~
            *          !   instead of an addition.  (EWD0001)     !     *~
            * 08/30/00 ! Change Transaction code IP to a withdwdal! CMG *~
            *          !   instead of an addition.  (EWD0002)     !     *~            
...
*                   1 2 3 4 5 6 7 8 9 A B C D E F1011
  ...
  /* (EWD0002) */         hny_withdraw,   /* IP = Physical adjustment  */~
  /* (EWD0001) */         hny_withdraw,   /* IW = Inventory Withdrawal */~
