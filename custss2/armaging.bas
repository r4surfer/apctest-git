        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *   AAA   RRRR   M   M   AAA    GGG   IIIII  N   N   GGG    *~
            *  A   A  R   R  MM MM  A   A  G        I    NN  N  G       *~
            *  AAAAA  RRRR   M M M  AAAAA  G  GG    I    N N N  G  GG   *~
            *  A   A  R  R   M   M  A   A  G   G    I    N  NN  G   G   *~
            *  A   A  R   R  M   M  A   A   GGG   IIIII  N   N   GGG    *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * ARMAGING - Determines A/R Aging at a Bill-to, Payment     *~
        ...
        sub "ARMAGING"   (billto$,       /* Bill-to Customer Code      */~
...
L09130:     init(hex(00)) currage$()
        ...
        tb_loop
            ...
            get #1 using L10150, discdue$, netdue$, amt, acct$,           ~
                                postdate$, sddate$, currency$
L10150:         FMT POS(30), CH(6), XX(1), CH(6), POS(68), PD(14,4),     ~
                    POS(76), CH(9), POS(97), 2*CH(6), POS(177), CH(4)
...
L10540:     aging(b%) = aging(b%) + amt  /* That's a big 'b' */
