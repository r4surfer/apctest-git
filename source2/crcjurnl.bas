...
L13780: %                                            **  T O T A L S  ** ~
        ...
        post_loop
            ...
            get #1 using L14180, acct$, billto$, check$, type$, dr, cr,   ~
                                gl_post_info$()
L14180:         FMT POS(12), 2*CH(9), CH(8), POS(42), CH(1), POS(55),    ~
                    2*PD(14,4), POS(101), 2*CH(255)
            dr = round(dr, 2)
            cr = round(cr, 2)
            net = dr - cr
            dr, cr = 0
