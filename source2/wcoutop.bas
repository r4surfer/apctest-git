        REM CAELUSASSOCIATESSPOKANEWASHINGTONALLRIGHTSRESERVEDCAELUSASSOC~
            *                                                           *~
            *  W   W   CCC    OOO   U   U  TTTTT   OOO   PPPP           *~
            *  W   W  C   C  O   O  U   U    T    O   O  P   P          *~
            *  W   W  C      O   O  U   U    T    O   O  PPPP           *~
            *  W W W  C   C  O   O  U   U    T    O   O  P              *~
            *   W W    CCC    OOO    UUU     T     OOO   P              *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * WCOUTOP  - RENAME EXISTING WCOUT FILE TO XWCOUT AND CREATE*~
            *            NEW WCOUT ON DEFAULT OUTVOL WITH SUFFICIENT    *~
            *            RECORDS ALLOCATED                              *~
            *-----------------------------------------------------------*~
        ...
        REM *************************************************************
        select #1, "WCOUT", varc, indexed, recsize = 68,                 ~
                   keypos =  9, keylen = 23,                             ~
