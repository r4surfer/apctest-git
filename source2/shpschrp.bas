        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *   SSS   H   H  PPPP    SSS    CCC   H   H  RRRR   PPPP    *~
            *  S      H   H  P   P  S      C   C  H   H  R   R  P   P   *~
            *   SSS   HHHHH  PPPP    SSS   C      HHHHH  RRRR   PPPP    *~
            *      S  H   H  P          S  C   C  H   H  R R    P       *~
            *   SSS   H   H  P       SSS    CCC   H   H  R  R   P       *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * SHPSCHRP - Prints a listing of scheduled shipments,       *~
            *            excluding those flagged as EXPORT.             *~
            ...
            * 11/03/87 ! Mod to skip Export Orders.               ! MJB *~
        ...
        dim                                                              ~
            ...
            sortkey$43,                  /* Key for sorting WORKFILE   */~
        ...
        REM *************************************************************~
            ...
            *-----+----------+------------------------------------------*~
            * #3  ! SHPHDRS  ! Shipment Scheduling Header File          *~
            ...
            *************************************************************
            ...
            select #9,  "WORKFILE", consec, recsize = 43
...
L09060:     u3% = 2%
            call "ASKUSER" (u3%, "* DOMESTIC SHIPPING SCHEDULE REPORT *",~
...
L09160:         hdr$ = "*** CANCEL REQUEST ***"
                msg$(1) = "There is no DOMESTIC shipping data to analyze"
...
L13220:         FMT CH(9),    /* KEY */ /* Customer Code (Ship to)     */~
            ...
            if export$  = "Y" then plow_thru_shphdrs  /* and Exports  */
...
L13510:         FMT CH(43)
        ...
        REM PRINT/DISPLAY LOGIC BEGINS HERE ****************************
            one_time$, eodsw$ = "0"
            call "SHOSTAT" ("Shipping Schedule Report in Progress")
        ...
        read_sorted_workfile
            ...
            get sortkey$ using L13720, stor_code$, ship_date$, carr_code$,~
                cust_code$, sord_nbr$, bill_lade$
L13720:              FMT CH(3), CH(6), CH(6), CH(9), CH(16), CH(3)
...
L13910:              FMT POS(42), CH(30), XX(120), CH(30)
        print_it
            ...
            print using L61350, dat8$, carr_code$, carr_name$, cust_code$,~
...
L60040: %RUN DATE: ######## @ ########      #############################~
        ~###############################                    SHPSCHRP######~
        ~#
L60070: %                                               DOMESTIC SHIPPING~
        ~ SHEDULE REPORT                                         PAGE: ###~
        ~#
L60100: %SCHEDULED                                SHIP TO   SHIP TO      ~
        ~                  SHIP TO
L60120: %SHIP DATE CARRIER CARRIER NAME (SHORT)   CUSTOMER  CUSTOMER NAME~
