...
L13680:              if descr% <> 99% then return
            ...
            descr_due:
                     ...
                     if duedatef$ <> " " and duedatef$ <> blankdate$ then ~
...
*        Post Mark Date                        POSTMARK$
            ...
            if postmark$ = " " or postmark$ = blankdate$ then ~
                                  postmark$ = chkdate$
            return
...
*        Due Date
            ...
            if adjdue$(c%) = " " or adjdue$(c%) = blankdate$ ~
                               then adjduef$ = postmark$
            return
...
L46320:     accept                                                       ~
               ...
               at (08,30), fac(lfac$( 4)), auto_ranges$(2)      , ch(10),~
               at (08,43), "to",                                         ~
               at (08,46), fac(lfac$( 4)), auto_ranges$(3)      , ch(10),~
                                                                         ~
...
*        Check Date                            CHKDATE$
            ...
            if errormsg$ = " " then ~
               call "DATREVRS" ( chkdate$, rev_date$, errormsg$ )
            return
...
L50840:         errormsg$ = "Invalid Entry for Net Check Amount"
                return
L50860:     if netchk >= -999999.99 and netchk <= 999999.99 then L51000
