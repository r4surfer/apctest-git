        ...
        dim                                                              ~
            ...
            fac1$1,    fac2$(16)1,       /* Part and Price Code FACs   */~
            ...
            part$25,                     /* Part Number                */~
            cpc(16), fpc(16), pc$(16)10, /* Price Code Unit Prices     */~
...
*        Now load in the Pricing information
            ...
            for i% = 1% to 8%
                cmarkup(i%), cmargin(i%), fmarkup(i%), fmargin(i%)       ~
                    = -999.99
            next i%
            key$ = "C" & part$
            call "CPRUPDSB" (#1, 0%, "00", key$, 0%, f1%(1))
            if f1%(1) = 0% then return
            get #1 using L30260, cby$, clcdat$, cpc(), cmarkup(),         ~
                eff_date$, fby$, flcdat$, fpc(), fmarkup()
L30260:              FMT XX(47), CH(3), CH(6), 16*PD(14,4), 8*PD(14,4),  ~
            ...
            *************************************************************
            ...
            if eff_date$ <> blank_date$ and eff_date$ <> " " then goto L31062
                ...
                for i% = 1% to 8%
                    fmarkup(i%) = -999.99
                next i%
L31062:     put fut_data$ using L31066, eff_date$, userid$, date, fpc(),  ~
                fmarkup()
L31066:         FMT CH(6), CH(3), CH(6), 16*PD(14,4), 8*PD(14,4)

            call "READ101" (#1, key$, f1%(1))

            put #1 using L31100, "C", part$, " ", userid$, date, cpc(),   ~
                cmarkup(), " ", fut_data$
L31100:              FMT CH(1), CH(25), CH(21), CH(3), CH(6),            ~
                         16*PD(14,4), 8*PD(14,4), CH(245), CH(207)
...
L40330:   accept                                                         ~
            at (01,02), "Price Code Management",                         ~
            at (01,67), "Date:",                                         ~
            ...
            at (16,10), fac(fac3$( 1)),   markup$( 1)           , ch(07),~
            at (17,10), fac(fac3$( 2)),   markup$( 2)           , ch(07),~
            at (18,10), fac(fac3$( 3)),   markup$( 3)           , ch(07),~
            at (19,10), fac(fac3$( 4)),   markup$( 4)           , ch(07),~
            at (16,48), fac(fac3$( 5)),   markup$( 5)           , ch(07),~
            at (17,48), fac(fac3$( 6)),   markup$( 6)           , ch(07),~
            at (18,48), fac(fac3$( 7)),   markup$( 7)           , ch(07),~
            at (19,48), fac(fac3$( 8)),   markup$( 8)           , ch(07),~
                                                                         ~
            at (16,19), fac(fac4$( 1)),   margin$( 1)           , ch(07),~
            at (17,19), fac(fac4$( 2)),   margin$( 2)           , ch(07),~
            at (18,19), fac(fac4$( 3)),   margin$( 3)           , ch(07),~
            at (19,19), fac(fac4$( 4)),   margin$( 4)           , ch(07),~
            at (16,57), fac(fac4$( 5)),   margin$( 5)           , ch(07),~
            at (17,57), fac(fac4$( 6)),   margin$( 6)           , ch(07),~
            at (18,57), fac(fac4$( 7)),   margin$( 7)           , ch(07),~
            at (19,57), fac(fac4$( 8)),   margin$( 8)           , ch(07),~
                                                                         ~
            at (16,29), fac(hex(8c))  ,   price$ ( 1)           , ch(10),~
            at (17,29), fac(hex(8c))  ,   price$ ( 2)           , ch(10),~
            at (18,29), fac(hex(8c))  ,   price$ ( 3)           , ch(10),~
            at (19,29), fac(hex(8c))  ,   price$ ( 4)           , ch(10),~
            at (16,67), fac(hex(8c))  ,   price$ ( 5)           , ch(10),~
            at (17,67), fac(hex(8c))  ,   price$ ( 6)           , ch(10),~
            at (18,67), fac(hex(8c))  ,   price$ ( 7)           , ch(10),~
            at (19,67), fac(hex(8c))  ,   price$ ( 8)           , ch(10),~
                                                                         ~
...
L41290:     if keyhit% <> 14 then return
        ...
        pfkeys_which     /* Keys for entering Which Section to edit   */
            ...
            pf$(1) = "(1)Start Over   (8)Manage Prices        " &        ~
                     "                       (13)Instructions"
            pf$(2) = "                (9)Manage Markups   (12)" &        ~
                     "Delete Record          (15)Print Screen"
            pf$(3) = "               (10)Manage Margins   (14)" &        ~
