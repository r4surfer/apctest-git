********************************************************************************
* CMS Procedure Control Program: PROCCORA - Core Acceptance Inventory Additions*
********************************************************************************
* Mod Date ! By  ! Description                                                 *
*----------+-----!-------------------------------------------------------------*
* 07/28/92 ! JRH ! Original                                                    *
...
********************************************************************************
        ...
        rem *************************************************************
        call "SHOSTAT" ("Preparing to enter Core Acceptance Transactions")
*STEP01:
        run$ = "CORACCPT"
        gosub Run_Program
