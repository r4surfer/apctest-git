...
L14390:     if lcntr% > 51 then gosub L18000      /* Page header  */
            ...
            partkey$ = part$
            if vpart$ <> " " then part$ = vpart$
            print skip(1)
            if istat$ = "W" and price = 0 then price$ = "    ADVISE"
            print using L60180, item$, irev$, part$, meas$, datedue$,     ~
                               qtyorig$, price$, ext$
...
L14570:     call "TXTPRINT" (#4, f2%(4), 87%, pntextid$, "VBK001", 5%,   ~
                  lcntr%, 54%, "N", " ", stat%)
...
L14640:     call "TXTPRINT" (#4, f2%(4), 87%, textid2$, "VBK001", 5%,    ~
                  lcntr%, 54%, "N", " ", stat%)
...
L14670:     call "TXTPRINT" (#4, f2%(4), 87%, vprtext$, "VBK001", 5%,    ~
                  lcntr%, 54%, "N", " ", stat%)
...
L18370:     call "TXTPRINT" (#4, f2%(4%), 87%, cpytextid$, "VBK001", 10%,~
                  lcntr%, 55%, "N", " ", stat%)
...
L18450:     call "TXTPRINT" (#4, f2%(4), 87%, textid1$,   "VBK001", 10%, ~
                  lcntr%, 55%, "N", " ", stat%)
...
L18530:     call "TXTPRINT" (#4, f2%(4), 87%, ventext$,   "VBK001", 10%, ~
                  lcntr%, 55%, "N", " ", stat%)
