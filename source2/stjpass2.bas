        REM *************************************************************~
            *                                                           *~
            *   SSS   TTTTT  JJJJJ  PPPP    AAA    SSS    SSS   222     *~
            *  S        T      J    P   P  A   A  S      S     2   2    *~
            *   SSS     T      J    PPPP   AAAAA   SSS    SSS     2     *~
            *      S    T    J J    P      A   A      S      S   2      *~
            *   SSS     T     J     P      A   A   SSS    SSS   22222   *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * STJPASS2 - Auto Reversal.                  A direct steal *~
            *            from (clone of) STJPASS1, this program limits  *~
            *            its activities to Currency Transactions only.  *~
            *-----------------------------------------------------------*~
            *                  M O D I F I C A T I O N S                *~
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 03/09/88 ! ORIGINAL (cloned from STJPASS1)          ! JIM *~
            * 05/09/90 ! If reversing jnl not posted, no reversals! JDH *~
            *          !  and SAVEFLAG remains as 'Y'.            !     *~
...
L09000: REM *************************************************************~
        ...
        REM *************************************************************~
            ...
            *************************************************************
            ...
            call "SHOSTAT" ("Auto-reversing Currency Journal entries")
...
L10100:     call "PLOWNEXT" (#5, oldreadkey$, 0%, f1%(5))
        ...
        REM Get STJMASTR Header fields
            get #5, using L10200, name$, description$, saveflag$,         ~
                reverseflag$, stopdate$, postedflag$

L10200:             FMT CH(10), CH(36), 2*CH(1), CH(06), CH(1)

            if str(name$,,4) <> "CURR" then L10100 /* This is the logic! */
