        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *  JJJJJ  BBBB   M   M  TTTTT  TTTTT   OOO   JJJJJ  BBBB    *~
            *    J    B   B  MM MM    T      T    O   O    J    B   B   *~
            *    J    BBBB   M M M    T      T    O   O    J    BBBB    *~
            *  J J    B   B  M   M    T      T    O   O  J J    B   B   *~
            *   J     BBBB   M   M    T      T     OOO    J     BBBB    *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * JBMTTOJB - Stand-alone driver for JBHNYSUB.               *~
            *            Provides the ability to move (xfer) component  *~
            *            parts from a job back into another job.        *~
        ...
        call "JBHNYSUB" ("03", "MJR",    /* GL Posting directives      */~
                         #1,             /* USERINFO  File UFB         */~
                         #2,             /* SYSFILE2  File UFB         */~
                         #3,             /* JBMASTR2  File UFB         */~
                         #4,             /* HNYMASTR  File UFB         */~
