        REM *************************************************************~
            *                                                           *~
            *   SSS   TTTTT  JJJJJ  FFFFF  IIIII  L      EEEEE    1     *~
            *  S        T      J    F        I    L      E       11     *~
            *   SSS     T      J    FFFF     I    L      EEEE     1     *~
            *      S    T    J J    F        I    L      E        1     *~
            *   SSS     T     J     F      IIIII  LLLLL  EEEEE  11111   *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * STJFILE1 - Posts Standard Journal Entries to the file, if *~
            *            the user wants it, and also deletes the Journal*~
            *            Entries if so desired.                         *~
            *-----------------------------------------------------------*~
            *                 M O D I F I C A T I O N S                 *~
            *---WHEN---+-----------------WHAT---------------------+-WHO-*~
            * 06/04/80 ! ORIGINAL (FROM GNJFILE1)                 ! BCW *~
            * 09/15/80 ! CLEANUP                                  ! TEM *~
            ...
            * 05/09/90 ! Pass posted flag from buffer to master.  ! JDH *~
...
L30230:                        FMT CH(13)
                if str(newreadkey$,1,10)<>str(oldreadkey$,1,10) then L30360
                   ...
                   get #10, using L30310,                                 ~
                            ...
                            debit(maxlines%), credit(maxlines%)
                   goto L30200
