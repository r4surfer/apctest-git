        ...
        dim                                                              ~
            ...
            industry$4, industrydesc$30, /* Industry Code & description*/~
            industryflag$1,              /* Industry codes on-file (yn)*/~
            ...
            pcodescr$32,                 /* Price code for optns descr.*/~
...
L09400
*        Check for GENCODES existence
            industryflag$, countryflag$, iccflag$ = "N"
            readkey$ = "INDUSTRY "
            call "PLOWNEXT" (#10, readkey$, 9%, f1%(10))
            if f1%(10) = 1% then industryflag$ = "Y"
...
*        Do Input for Variable Fields
            call "VFINPSUB" ("CUSTOMER", "I", "Manage Customer Master",  ~
...
L11170:     fieldnr% = cursor%(1) - 3%
                if fieldnr% <> 1% or cursor%(2) < 46% then L11210
                     fieldnr%  = 7%
                     goto L11260
L11210:         if fieldnr%  < 2 or  fieldnr% >  16 then editpg1
...
L12400:     if u3%  = 1% then inputmode        /* Branch per pf key    */
        ...
        editpg6      /* Edit Variable Fields       */
            call "VFINPSUB" ("CUSTOMER", "E", "Manage Customer Master",  ~
...
L27320:  if f% > 0% then L27408           /* Edit Mode- Select Field    */
           pf$(1) = "(1)Start Over                            (10)Core "&~
                    "Parent       (13)Instructions"
           ...
           str(pfkeys$())=hex(0102030405ffffffff0affff0dff0f10ff191d001a)
           if retrieved% <> 0% then goto L27384
                str(pf$(3%),42%,19%) = " " : str(pfkeys$(21%)) = hex(ff)
L27384:    if retrieved% = 1% and core_track% = 1% and str(customer$,,1) ~
                <> hex(00) then goto L27390
                str(pf$(1),42,15) = " " : str(pfkeys$(),10,1) = hex(ff)
L27390:    return
...
L27480: data                                                             ~
        ...
        /* And the after-thoughts                                      */~
         ...
         "Enter Customer's Industry Code or leave blank.               ",~
        ...
        init_for_inputmode
            ...
            init(" ") errormsg$, inpmessage$, currency$, currdesc$,      ~
                      ...
                      industry$, industrydesc$, country$, countrydesc$,  ~
...
*        Define Screen, Field Cross Ref and Field Enable Settings.
            ...
            scr%(1, 5) = 40% : set%(40) =  2%      /* Industry Code    */
...
*        The next available item is number 52.
...
L30080:     get #01 using L35060, temp$, sort$, soldto$(), opened$,       ~
                ...
                nbrdays%, cdchng$, cduser$, industry$, country$,         ~
                icc_d$, icoc_d$, export$, xref_cus$, xref_mnf$,temp$
...
L30805:     if industry$ = " " then L30820
                readkey$ = "INDUSTRY " & industry$
                call "DESCRIBE" (#10, readkey$, industrydesc$, 0%,f1%(10))
...
L30845:     /*Test the PM vars for junk do to using a new filler area */
        ...
        save_data
            ...
            if limit = origlimit then L31110
...
L31320:     put #01 using L35060, customer$, sort$, soldto$(), opened$,   ~
                ...
                taxable$, exempt$, vf$, poreqd$, bal$, docs$, type$,     ~
                taxcode$, fcacct$, fctable$, currency$, crparent$,       ~
                nbrdays%, cdchng$, cduser$, industry$, country$, icc_d$, ~
                icoc_d$, export$, xref_cus$, xref_mnf$, " "
...
L35060: FMT                 /* FILE #01 -- CUSTOMER                    */~
            ...
            XX(30),         /* Filler (Balances move to CCRMASTR)      */~
...
L40304:     accept                                                       ~
               ...
               at (17,59), fac(lfac$( 4)), str(soldto$(6),27, 4), ch(04),~
                                                                         ~
               at (18,02), "Industry Code (SIC)",                        ~
               at (18,30), fac(lfac$( 5)), industry$            , ch(04),~
               at (18,48), fac(hex(8c)),   industrydesc$        , ch(30),~
                                                                         ~
...
*        Industry Code (SIC)                   INDUSTRY$
            industrydesc$ = " "
            if industry$  = " " or industryflag$ = "N" then return
                readkey$ = "INDUSTRY " & industry$
                call "PLOWCODE" (#10, readkey$, industrydesc$, 9%, .30,  ~
                                                                 f1%(10))
                if f1%(10) = 1% then L50500
                     errormsg$ = "Industry Code not on file."
                     return
L50500:         industry$ = str(readkey$,10)
                return
...
*        Price Code for Options                PCO$
            ...
            if (pco$ >= "A" and pco$ <= "Q") or                          ~
               (pco$ >= "0" and pco$ <= "8") then L51545
                errormsg$ = "Price Code must be 'A'-'Q' or '0'-'8'."
                return
...
*        Customer Status                       STATUS$
            if status$ = "A" or status$ = "D" or status$ = "H" or        ~
               status$ = "I" then L52174
                errormsg$ = "Enter 'A', 'D', 'H', or 'I'."  : return
