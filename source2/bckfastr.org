        REM CAELUSASSOCIATESSPOKANEWASHINGTONALLRIGHTSRESERVEDCAELUSASSOC~
            *                                                           *~
            *  BBBB    CCC   K   K  FFFFF   AAA    SSS   TTTTT  RRRR    *~
            *  B   B  C   C  K  K   F      A   A  S        T    R   R   *~
            *  BBBB   C      KKK    FFFF   AAAAA   SSS     T    RRRR    *~
            *  B   B  C   C  K  K   F      A   A      S    T    R  R    *~
            *  BBBB    CCC   K   K  F      A   A   SSS     T    R   R   *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * BCKFASTR - A 'speedy', 'off-line' verison cloned from     *~
            *            BCKONLIN.  Allows for entry of orders with     *~
            *            the appearance of having only one screen for   *~
            *            normal entry.                                  *~
            *-----------------------------------------------------------*~
...
*        Now get Order, new dates, etc., etc., etc..
            ...
            if cuscode$ = keepcus$ then L10610
                ...
                get #01 using L10600, soldto$(), dfltacks$, shipto$()
L10600:         FMT POS(40), 6*CH(30), POS(238), CH(1), POS(253), 6*CH(30)
L10610:     so$       = keepso$
...
*        FIRST add up the order and determine if it is on credit hold.
            ...
            mat tlines% = zer
            inpmessage$ = " "
            if crhold$ <> "C" then L19135
              adjmsg$ = "Cancellation Reason Code"
                  goto L19150
L19135:       adjmsg$ = "Adjustment Reason Code"
...
*          'O' - Automatic Hold, override of Manual Setting
            ...
            crmsg$() = " "
            if crhold$ <> "C" then L19528
                how_held$ = " " : goto L19590
L19528:     if crflag$ <> "O" then L19530
L19529:         crhold$, how_held$ = " " : goto L19535
L19530:     if crflag$ = "N" then L19590    /* Flags stay 'as are'. */
            if how_held$ <> "M" then L19529 /*To get this far CRFLAG$='Y'*/
                if crhold$ = "H" then                                    ~
                    crmsg$(1) = "*'Manually' Held Order*"
                goto L19590
L19535:     if tqty = 0 and topen(4) = 0 then L19590 /* Nothing there */
...
L33725:     if pm_inv$ <> " " then return
        ...
        REM *************************************************************~
            ...
            *************************************************************
        save_line
            if str(lsts$(c%),,3) <> "DEL" then L34260
                call "TXTFUTIL" (#22, f2%(22), "XOUT", textidl$(c%))
...
L38410:     errormsg$ = " "
        ...
        deffn'101(fieldnr%, edit%)
            str(line1$,20%,33%) = "Main Screen"
            if fieldnr% = 1% and edit% = 1%                              ~
                then str(line1$,28%,24%) = "n Last: " & last_so$         ~
                else str(line1$,35%,15%) = "Currency: " & currency$
            scrtext$ = "Ship-to :"
...
L40410:        if keyhit% <> 13 then L40425
                  call "MANUAL" ("BCKFASTR") : goto L40130

L40425:        if keyhit% <> 15 then L40440
...
L40440:         close ws
        ...
        if edit% = 2% then L40524         /* Input Mode                 */
           ...
           pfkey$ = hex(01ff03ffffffffffffffffff0dff0f10ffff1a1b00)
...
L40568:    if allow_delete$ <> "N" then L40575
           if str(lsts$(c%),2) = "A" or str(lsts$(c%),2) = "R" then L40575
               str(pf$(1%),24%,10%) = " " : str(pfkey$,12%,1%) = hex(ff)
L40575:    return
...
L41630:        if keyhit% <> 13 then L41645
                  call "MANUAL" ("BCKFASTR") : goto L41175

L41645:        if keyhit% <> 15 then L41660
                  call "PRNTSCRN" : goto L41175
...
L41660:         close ws
        ...
        setpf2
         if fieldnr% > 0% then L41790     /* Edit Mode- Select Option   */
           pf$(1) = "(1)Start Over      (9)Variable Fields             "&~
                    "             (13)Instructions"
           pf$(2) = "                                        (25)Manage"&~
           ...
           gosub'040(textid$)
           str(pf$(2),40,1) = fac25$
           pfkey$ = hex(01ffffffffffffff09ffffff0dff0f10ff191d1a00)
           return
...
L46040:        if keyhit% <> 13 then L46070
                  call "MANUAL" ("BCKFASTR") : goto L45150

L46070:        if keyhit% <> 15 then L46100
                  call "PRNTSCRN" : goto L45150
...
L46250:  if fieldnr% > 0% then L46360     /* Edit Mode- Select Option   */
           pf$(1) = "(1)Start Over                 (9)Return to Edit Or"&~
                    "der          (13)Instructions"
           pf$(2) = "                                         (24)Overr"&~
                    "ide Cr Hold  (15)Print Screen"
           pf$(3) = "                                         (26)Custo"&~
                    "mer Credit   (16)Save Order  "
           pfkey$ = hex(01ffffffffffffff09ffffff0dff0f10ff181a00)
...
L50321:              call "CUSCHECK" (cuscode$, cr_ar_only$, #01, ret%)
...
*        PURCHASE ORDER NUMBER                 PO$
            if po$ <> " " then goto L50560
                get #01 using L50546, poreqd$
...
*        Price Code Default                    PC$
            if (pc$ >= "A" and pc$ <= "Q") or                            ~
               (pc$ >= "0" and pc$ <= "8") then goto L50955
...
*        Get Options for this part (Input Mode Only)
            if edit% = 1% and parttype$(c%) = "000" then gosub options
