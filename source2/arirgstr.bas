        ...
        REM *************************************************************~
            ...
            *************************************************************
            ...
            call "SHOSTAT" ("Invoice Register(s) are being printed")
        ...
        plow_thru_ariregtf
            ...
            get #3 using L10120, session$, invoice$, cust_code$,          ~
                ...
                bol$, discount, freight, salestax, netamount
...
L10120:         FMT  XX(3),              /* User ID                    */~
            ...
            print using L60180, invoice$, billtoxref$, cust_code$,        ~
                ...
                stor_code$, str(so$,,16) & "-" & bol$, discount, freight,~
                salestax, netamount
        ...
        end_of_session
            ...
            if nbr_lines% > max_lines% then gosub page_heading
            print using L60210 /* UNDERSCORES */
            print using L60240, rt_disc, rt_frgt, rt_stax, rt_namt
            rt_disc, rt_frgt, rt_stax, rt_namt = 0
            print
            time$ = " " : call "TIME" (time$)
...
L60120: %NUMBER   NUMBER    NUMBER    SHIP-TO NAME (SHORT)      TYPE STR ~
        ~SALES ORDER #   -BOL   DISCOUNT    FREIGHT  SALES TAX     NET AMO~
        ~UNT
L60150: %-------- --------- --------- ------------------------- ---- --- ~
        ~-------------------- ---------- ---------- ---------- -----------~
        ~---
