        REM *************************************************************~
            *                                                           *~
            *  Program Name      - APCBARGN                             *~
            *  Creation Date     - 01/06/97 - Barcode File - (APCBARGN) *~
            *  Last Modified Date- 11/17/97                             *~
            *  Written By        - Browning Fields                      *~
            *                                                           *~
            *  Description       - Print Barcode labels for selected    *~
            *                      GENCODES table.                      *~
            *                                                           *~
            ...
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 01/06/97 ! New Program for (APC) - Last Mod Date    ! JBF *~
            * 11/17/97 ! Mod for Upgrade to R6.04.03              ! RHH *~
            *************************************************************
        ...
        REM *************************************************************~
            ...
            *************************************************************
            dim apc$40, pname$21
            apc$   = "(EWD) Barcode Labels for GENCODES Tables"
            pname$ = "APCBARGN - Rev: R6.04"
...
L11180:     gosub'101(fieldnr%, 2%)     /* Display & Accept Screen     */
        ...
        begin_process
            ...
            for i% = 1% to qty%
                ...
                str(readkey$,10%,15%) = "  "
                read #1,key > readkey$, using L19160, gen_rec$, desc$,    ~
                    eod goto L19220
L19160:             FMT CH(24), CH(25)
...
L19220:     close #2
        ...
        process_gencodes
            put #2, using L35030,                                         ~
                "{1``",                            /* Label Def.   ( 4)*/~
                str(gen_rec$,10%,15%), "`",        /* Gencode Code (16)*/~
                str(gen_rec$,10%,15%), "`",        /* Barcode      (16)*/~
                desc$,                 "`",        /* Description  (26)*/~
                "}"                                /* End of Label ( 1)*/
            ...
            if str(gen_rec$,1%,9%) <> table$ then L19420
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        scrn1_msg  :  data                                               ~
         "Enter a Valid GENCODES Table Name.                           ",~
...
L35030:     FMT CH(4),                             /* Label Def.   ( 4)*/~
                CH(15), CH(1),                     /* GENCODES Code(16)*/~
                CH(15), CH(1),                     /* Barcode      (16)*/~
        ...
        deffn'101(fieldnr%, edit%)
            ...
            on fieldnr% gosub L40160,           /* Gencodes Table       */~
                              L40170            /* Label Quantity       */
            goto L40190
...
L50110: REM Edit GENCODES Table Name              TABLE$
            if table$             = " " then L50210
            readkey$              =  all(hex(00))
            str(readkey$,1%,9%)   =  table$
            str(readkey$,10%,15%) = "  "
            read #1,key > readkey$, using L50180, gen_rec$,               ~
                eod goto L50210
L50180:         FMT CH(24)

            if str(gen_rec$,1%,9%) = table$ then L50220
L50210:     errormsg$ = "(Error) - Must Enter a Valid GENCODES Table ?"
L50220: return

L50240: REM Edit Label Quantity                   QTY$
            convert qty$ to qty%, data goto L50280

            if qty% > 0%               then L50290
L50280:     qty%    = 1%
L50290:     convert qty% to qty$, pic(00)
        return
