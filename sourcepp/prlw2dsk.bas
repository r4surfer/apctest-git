        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *  PPPP   RRRR   L      W   W   222   DDDD    SSS   K   K   *~
            *  P   P  R   R  L      W   W      2  D   D  S      K  K    *~
            *  PPPP   RRRR   L      W   W   222   D   D   SSS   KKK     *~
            *  P      R  R   L      W W W  2      D   D      S  K  K    *~
            *  P      R   R  LLLLL   W W   22222  DDDD    SSS   K   K   *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * PRLW2DSK - Creates a W-2 Floppy Disk file.                *~
            *-----------------------------------------------------------*~
            ...
            * 12/13/90 ! Cloned from PRLW2TAP                     ! KAB *~
        ...
        dim                              /* General Purpose Variables  */~
                ...
                savekey$100,             /* Extract File Saveed Key    */~
        ...
        REM *************************************************************~
            ...
            *************************************************************~
            ...
            select #10, "PRW2DISK",       consec,  recsize = 128,        ~
                        eod goto L65000
...
L10000: REM *************************************************************~
            ...
            *************************************************************
            ...
            call "SHOSTAT" ("Creating W-2 Data File for Diskette")
            next% = 1%

        REM Write out Header records

            put #10 using L10270,         /* Type A Record              */~
                "1A",                    /* Record Indentifier - '1A'  */~
                pay_year$,               /* Payment Year               */~
                ein$,                    /* Transmitter E.I.N. #       */~
                filler$,                 /* Blanks                     */~
                forgn_a$,                /* Foreign Address flag       */~
            ...
            put #10 using L10333,         /* Type A Record              */~
                "2A",                    /* Record Indentifier - '2A'  */~
                city$,                   /* City                       */~
                state$,                  /* State                      */~
                filler$,                 /* Blanks                     */~
                zip_extn$,               /* Zip Code extension         */~
...
L10270:     FMT CH( 2),                  /* Record Indentifier - '1A'  */~
                CH( 4),                  /* Payment Year               */~
                CH( 9),                  /* Transmitter E.I.N. #       */~
                CH( 8),                  /* Blank                      */~
                CH( 1),                  /* Foreign Address flag       */~
...
L10333:     FMT CH( 2),                  /* Record Indentifier - '2A'  */~
                CH(25),                  /* City                       */~
                CH( 2),                  /* State                      */~
                CH( 8),                  /* Blanks                     */~
                CH( 5),                  /* Zip Code extension         */~
            ...
            put #10 using L10673,         /* Type B Record              */~
                "2B",                    /* Record Identifier - '2B'   */~
                filler$,                 /* Blanks                     */~
                forgn_b$,                /* Foreign Address flag       */~
                ret_name$,               /* File Return Name           */~
                ret_address$,            /* File Return Address        */~
...
L10640:     FMT CH( 2),                  /* Record Identifier - '1B'   */~
                CH( 4),                  /* Payment Year               */~
                CH( 9),                  /* Transmitters E.I.N. #      */~
                CH( 8),                  /* Computer                   */~
                CH(105)                  /* Blanks                     */

L10673:     FMT CH( 2),                  /* Record Identifier - '2B'   */~
                CH(13),                  /* Blanks                     */~
                CH( 1),                  /* Foreign Address flag       */~
                CH(44),                  /* File Return Name           */~
                CH(35),                  /* File Return Address        */~
            ...
            put #10 using L11134,         /* Type E Record              */~
                "2E",                    /* Record Identifier - '2E'   */~
                city$,                   /* City                       */~
                state$,                  /* State                      */~
...
L11080:     FMT CH( 2),                  /* Record Identifier - '1E'   */~
                CH( 4),                  /* Payment Year               */~
                CH( 9),                  /* Employer E.I.N. #          */~
                CH( 9),                  /* State/Local 69 Number      */~
                CH(50),                  /* Employer Name              */~
...
L11134:     FMT CH( 2),                  /* Record Identifier - '2E'   */~
                CH(25),                  /* City                       */~
                CH(10),                  /* State                      */~
                CH( 5),                  /* Zip/Foreign extension      */~
                CH( 5),                  /* Zip Code                   */~
...
L14390:     FMT CH( 2),                  /* Record Identifier - '1W'   */~
...
L14473:     FMT CH( 2),                  /* Record Identifier - '2W'   */~
...
L14770:     FMT CH( 2),                  /* Record Identifier - '3W'   */~
                CH( 9),                  /* Medicare Wages             */~
                CH( 7),                  /* Medicare Tax               */~
                CH(110)                  /* Blank                      */
...
L16780:     FMT CH( 2),                  /* Record Identifier - '1I'   */~
...
L17144:     FMT CH( 2),                  /* Record Identifier - '2I'   */~
...
L18500:     FMT CH( 2),                  /* Record Identifier - '1T'   */~
...
L18633:     FMT CH( 2),                  /* Record Identifier - '2T'   */~
...
L20290:     FMT CH( 2),                  /* Record Identifier - '1F'   */~
...
L35160:     if line% > 55% then gosub page_footer
            record% = record% + 1%
            get #10 using L35190, str(line$(),1,128)
L35190:         FMT CH(128)
            ...
            for i% = 1% to 5% : str(line1$,11%*i%,1) = "." :next i%
            str(line1$,56) = " "
...
L37000: %DATE: ######## TIME: ########     PAYROLL W-2 DISKETTE FILE GENE~
        ~RATION
