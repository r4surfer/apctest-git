        ...
        REM *************************************************************~
            ...
            *   5 ! HNYDETAL ! Inventory Details                        *~
            *   6 ! HNYPOOL  ! Inventory LIFO/FIFO Pools                *~
            *   7 ! HNYMASTR ! Inventory Master                         *~
...
*       ****************************************************************
        ...
        call "READ100" (#7, part$, stocked%)    /* HNYMASTR */
...
*        First see if we need to Reverse any interim GL Postings.
            ...
            if caller$ <> "I" or bol$ = " " or net(l%, 1) = 0 then L11240
                call "HNYGLGET" (part$, store$, net$(l%), cogs$, 4%,#7,#4)
...
*        Now Update Inventory via HNYPOST and record G/L Postings
            ...
            if netqty = 0 then L11790     /* No Inventory Movement      */
                ...
                hnyassests$ = " "
                call "HNYPST2" (part$, store$, net$(l%), netqty, 0, 0, 0,~
