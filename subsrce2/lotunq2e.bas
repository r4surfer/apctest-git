        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *  L       OOO   TTTTT  U   U  N   N   QQQ   22222  EEEEE   *~
            *  L      O   O    T    U   U  NN  N  Q   Q     22  E       *~
            *  L      O   O    T    U   U  N N N  Q   Q    22   EEEE    *~
            *  L      O   O    T    U   U  N  NN  Q Q Q   22    E       *~
            *  LLLLL   OOO     T     UUU   N   N   QQQ   22222  EEEEE   *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * LOTUNQ2E - Tests that lot number entered is unique within *~
            *            arrays passed in. Version of 2-dimensional     *~
            *            arrays.                                        *~
            *-----------------------------------------------------------*~
        ...
        sub "LOTUNQ2E" (part$(), lot$(), c%, #1, errormsg$)

*        PART$() is the list of part numbers (2 dimensions).
...
*          track flag settings.
        ...
        dim                                                              ~
            ...
            lot$(100)6,                  /* Lot Number Array           */~
            lotflag$1,                   /* Lot Track Flag             */~
            part$(100,2)25,              /* Part Number Array          */~
