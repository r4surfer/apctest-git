        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *  FFFFF  RRRR   N   N   GGG   EEEEE   SSS   U   U  BBBB    *~
            *  F      R   R  NN  N  G      E      S      U   U  B   B   *~
            *  FFFF   RRRR   N N N  G GGG  EEEE    SSS   U   U  BBBB    *~
            *  F      R   R  N  NN  G   G  E          S  U   U  B   B   *~
            *  F      R   R  N   N   GGG   EEEEE   SSS    UUU   BBBB    *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * FRNGESUB - SUBROUTINE VERSION OF XXXINPUT PROGRAM TO MANAG*~
            *            FRINGE BENEFITS - CALLED FROM PERINPUT.  NOTE  *~
            *            INPUT/EDIT MODE ACCESSED FROM 'LINE SUMMARY'   *~
            *            SCREEN.                                        *~
            *-----------------------------------------------------------*~
        ...
        sub "FRNGESUB" (#1, #2, #3, #4, #5, #6, #7, #8, #9, employee$)


        REM EMPLOYEE$ = THE EMPLOYEE CODE FOR THE EMPLOYEE DESIRED
...
cms_start
        ...
        ~ Desired Value And Press (ENTER)."
                     ...
                     get #8, using L09113 , lname$, fname$, mname$
L09113:              FMT XX(1), CH(15), CH(10), CH(1)
...
L41175:     accept                                                       ~
               ...
               at (22,02),                                               ~
                  "P.F. KEYS ACTIVE:",                                   ~
               at (23,02),                                               ~
                  "(13)INSTRUCTIONS      (12)DELETE THIS BENEFIT IMMEDIAT~
        ~LY",                                                             ~
               at (23,65),                                               ~
                  "(15)PRINT SCREEN",                                    ~
               at (24,68),                                               ~
