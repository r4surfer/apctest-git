        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *  H   H  N   N  Y   Y  DDDD   DDDD   IIIII   SSS   PPPP    *~
            *  H   H  NN  N  Y   Y  D   D  D   D    I    S      P   P   *~
            *  HHHHH  N N N   YYY   D   D  D   D    I     SSS   PPPP    *~
            *  H   H  N  NN    Y    D   D  D   D    I        S  P       *~
            *  H   H  N   N    Y    DDDD   DDDD   IIIII   SSS   P       *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * HNYDDISP - Display HNYDETAL Info for Part Specified.      *~
            *----------------------------------------------------------Q*~
        ...
        sub "HNYDDISP"   (partin$,       /* Part Number to Display     */~
...
*          values.
        ...
        dim                                                              ~
            ...
            ctlpart$25,                  /* Control Break for Report   */~
            ...
            descr$32, descr1$60,         /* Part Description           */~
            ...
            keys$(16)42,                 /* Keys to HNYDETAIL for recal*/~
            lastpart$25,                 /* Last Part Described        */~
            ...
            part$25, part$(2,2)25,       /* Part Number, Ranges        */~
            part1$25,                    /* Part Number for Reports    */~
...
L02230:         FMT CH(3), CH(47)
        ...
        REM *************************************************************~
            ...
            *************************************************************
            ...
            date$ = date
            call "DATEFMT" (date$)
            str(line2$,62) = "HNYDDISP: " & str(cms2v$,,8)
...
L09540:     call "READ100" (#1, part$, f1%(1))
            if f1%(1) = 0% then exit_program
                get #1 using L09570, part$, descr$
L09570:              FMT CH(25), CH(32)
...
L09640:         u3% = 2%
                call "ASKUSER" (u3%, "HNYDETAL DISPLAY",                 ~
...
L10000: REM *************************************************************~
            ...
            *************************************************************
            ...
            plowkey$ = str(part$,,25) & str(str$(2,1)) & lot$(2,1)
            gosub load_screen
...
L10300:         if f1%(2) = 0 then main_screen
                if str(key(#2,0),,25) <> part$ then main_screen
                get #2 using L10330, str$, lot$, hnydate$, tc$
L10330:              FMT XX(25), CH(3), CH(6), POS(43), CH(6), CH(2)
...
L11040:     gosub set_pf_criteria
        ...
        report_printing:  /* Produce Report per Criteria specified     */
            ...
            runtime$ = " "
            call "TIME" (runtime$)
            plowkey1$ = str(part$(2,1),,25) & str(str$(2,1))
...
L11860:     if part1$ <> ctlpart$ then gosub part_totals
        ...
        load_detail:
            get #2 using L12040, part1$, str$, lot$, temp$, hnydate$, tc$,~
                                ...
                                tdate$, stdcost
L12040:         FMT CH(25), CH(3), CH(6), XX(4), CH(4), CH(6), CH(2),    ~
...
L30090:     call "PLOWNEXT" (#2, plowkey$, 25%, f1%(2))
            if f1%(2) = 1% then L30140
L30110:         l% = l% + 1%
                dsply$(l%) = "** END OF DATA **"
                return
L30140:     get #2 using L30150, str$, lot$, hnydate$, tc$,qty, amt, text$
L30150:         FMT XX(25), CH(3), CH(6), POS(43), CH(6), CH(2),         ~
                    2*PD(14,4), POS(83), CH(40)
...
L30220:         l% = l% + 1%
        ...
        load_totals
            init (" ") dsply$(1)
            t1, t2 = 0 : c% = 0%
            plowkey1$ = str(part$,,25) & str(str$(2,1)) & hex(00)

L30380:     call "PLOWNEXT" (#2, plowkey1$, 25%, f1%(2))
...
L42130:     accept                                                       ~
               ...
               at (04,02), fac(hex(94)), errormsg$              , ch(79),~
                                                                         ~
               at (06,02), "Part Codes",                                 ~
               at (06,14), fac(lfac$    ), part$(1,1)           , ch(25),~
               at (06,41), fac(lfac$    ), part$(1,2)           , ch(25),~
                                                                         ~
               at (07,02), "Dates",                                      ~
               at (07,14), fac(lfac$    ), dat$ (1,1)           , ch(10),~
               at (07,41), fac(lfac$    ), dat$ (1,2)           , ch(10),~
                                                                         ~
               at (08,02), "Stores",                                     ~
               at (08,14), fac(lfac$    ), str$ (1,1)           , ch(05),~
               at (08,41), fac(lfac$    ), str$ (1,2)           , ch(05),~
                                                                         ~
               at (09,02), "Lots",                                       ~
               at (09,14), fac(lfac$    ), lot$ (1,1)           , ch(08),~
               at (09,41), fac(lfac$    ), lot$ (1,2)           , ch(08),~
                                                                         ~
               at (10,02), "Trans Codes",                                ~
               at (10,14), fac(lfac$    ), tcc$ (1)             , ch(03),~
                                                                         ~
               at (21,02), fac(hex(a4)),   inpmessage$          , ch(79),~
               at (22,02), fac(hex(8c)),   pf$(1)               , ch(79),~
               at (23,02), fac(hex(8c)),   pf$(2)               , ch(79),~
