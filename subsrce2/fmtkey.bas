        REM *************************************************************~
            *                                                           *~
            *  FFFFF  M   M  TTTTT  K   K  EEEEE  Y   Y                 *~
            *  F      MM MM    T    K  K   E      Y   Y                 *~
            *  FFFF   M M M    T    KKK    EEEE    YYY                  *~
            *  F      M   M    T    K  K   E        Y                   *~
            *  F      M   M    T    K   K  EEEEE    Y                   *~
            *                                                           *~
            *-----------------------------------------------------------*~
...
L10140:                          FMT CH(3), CH(4)
                         if tempuserid$ <> userid$ then L10180
                         convert temp$ to bufferseqnr%

L10180:         REM CONVERT WHATEVER WE THOUGHT WAS IT TO THE KEY.
                    key$, reversekey$ = userid$
                    convert bufferseqnr% + 1 to str(key$, 4, 4), pic(####)
