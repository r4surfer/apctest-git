        REM *************************************************************~
            ...
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 08/15/01 ! (New) Program -                          ! CMG *~
            * 03/04/22 ! CR3042 Add user RDB and RBN              ! RDB *~            
            *************************************************************

        dim                                                              ~
            purge_key$57,                /* For Purge Utilities        */~
...
/* CR3042 */
            if userid$ <> "CMG" and userid$ <> "CGN" and userid$ <> "FJH"~
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        scrn1_msg  :  data                                                   ~
         "Enter a Valid End Purge Date for (APCPLNDT)?"
...
L40190:     gosub set_pf1
            accept                                                       ~
               ...
               at (02,02), fac(hex(94)), errormsg$              , ch(79),~
                                                                         ~
               at (05,02), "End Purge Date (APCPLNDT):",                 ~
...
L50010: REM End Purgre Date APCPLNDT         END_DATE$, END_DTE$   
...
L50020:     errormsg$ = "(Error) Invalid Purge Date?"
        ...
        purge_apcplndt
            ...
            cnt% = 0%
        purge_apcplndt_nxt
            read #1, hold, key 1% > purge_key$, using L60000, purge_key$,     ~
                                           eod goto purge_apcplndt_done

L60000:        FMT POS(47), CH(57)
