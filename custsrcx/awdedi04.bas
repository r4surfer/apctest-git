        REM *-----------------------------------------------------------*~
            *                                                           *~
            * AAAAAA  W   W DDDD   EEEE  DDDD  IIIIII   0000   44 44    *~
            * AA  AA  W   W DD  D  EE    DD  D   II    0    0  44 44    *~
            * AAAAAA  W W W DD  D  EEEE  DD  D   II    0    0  44444    *~
            * AA  AA  WW WW DD  D  EE    DD  D   II    0    0     44    *~
            * AA  AA  W   W DDDD   EEEE  DDDD  IIIIII   0000      44    *~
            *-----------------------------------------------------------*~
            * AWDEDI04 - Create Flat File To Send To IPNET              *~
            *-----------------------------------------------------------*~
            *                  M O D I F I C A T I O N S                *~
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 10/05/04 ! Original                                 ! CMG *~
        ...
        REM *************************************************************~
            ...
            *-----+----------+------------------------------------------*~
            * #1  ! AWDEDIIB ! AWD EDI Master IBSA File              *~
            * #3  ! GENCODES ! GENCODES Table File                      *~
            * #4  ! EWDIPNSN ! EWD IPNet Send Flat File                 *~
            *************************************************************~
