...
PHASE2: 
             edi_key2$ = "TI120900202587822"
             tmp_key2$ = "TI1211002        "

L03000:      read #1,hold, key > edi_key2$, using FMT001, edi_rec$,   ~
                           eod goto END_JOB 
             edi_key2$ = str(edi_rec$,1,22)
	     if str(edi_key2$,1,9) > str(tmp_key2$,1,9) then goto END_JOB
             if str(edi_key2$,7,3) <> "002" then goto L03000
	     if str(edi_key2$,10,8) < "02587823" then goto L03000
	     if str(edi_key2$,10,8) > "02590273" then goto L03000
             delete #1
             str(edi_rec$,1,1) = "S"
            cnt2% = cnt2% + 1%
