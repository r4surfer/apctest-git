        REM *************************************************************~
            ...
            *----------!------------------------------------------!-----*~
            * 10/16/98 ! (EWD001) Add PF8/9; other minor mods.    ! BWS *~
            * 05/19/06 ! (EWD002) Add check for auth to disp phone! DES *~
	        *02/11/2019! CR-1894 Increase Emp Dept field          ! DES *~
            *03/20/2020! CR2490 Change employee user ID format    ! RDB *~
            *06/24/2020! CR2614 Max rows with new Dayforce        ! RDB *~
            *************************************************************
...
/*EWD001*/  find_numb$8,                 /* Emp. No. to Find  CR2490   */~
...
L01930:        if keyhit% <> 8% then goto L01940    /*EWD001 - New*/
                  for x% = 1% to i_max%             /* CR2490 */
                    if str(scr$(x%),1%,8%) = find_numb$ then i% = x% 
                  next x%
                  goto L01410
