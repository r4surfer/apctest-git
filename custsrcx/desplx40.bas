        ...
        dim c1$(6000%)5, count$26,       /* Product Sequence No.       */~
            ...
            c6$(6000%)8,                 /* Production Date (EWD006)            (Y2K, LDJ)*/~
...
REM            call "SHOSTAT" (" DATALOAD " )  stop
            ...
            dt_time$ = ad_time$
            dt_st$   = ad_st$
	    if dt_bar$ <> "026677430400010002" then goto not_ad:
	    des_bar$ = dt_bar$
...
REM TO DO what is this for??
                                                /* Not Scanned Values  */

/* <AWD014> */     
            if sc_sel$ = "1" and dt_st$ = "15" then  ~
                 goto L30270
            if sc_sel$ = "1" and sc_dept$ = "032" then  ~
                 goto L30275
            if sc_sel$ = "3" and sc_dept$ = "032" then  ~
                 goto L30342
            goto L30280
L30270:
/* <AWD015> */ 
            if sc_dept$ <> "ALL" and sc_dept$ <> "032"  then return
/* </AWD015> */ 
L30275:
...
REM         goto L30340
L30280:
            if sc_sel$ = "1" and dt_st$ = "15" then goto L30335
            if sc_sel$ = "3" and sc_dept$ = "032" then goto L30342
            if sc_sel$ <> "1" or sc_dept$ <> "032" then goto L30340
L30335:     for i% = 1% to supp_max%                     /* Find Dept. */
                if dt_dept$ = supp$(i%) then goto L30360    /* Subscript  */
            next i%
            if dt_st$ = "15" then return        
REM	    if (dt_st$ = "15") then goto L30347
            if (dt_dept$ = "032" and dt_st$ < "12") then goto L30347
            goto L30360                       /* Sashs, Parts By Dept*/
           
L30340:
/* </AWD014> */
            if sc_sel% = 6% and dt_st$ <> "13" then goto L30360
            if sc_sel% = 7% and dt_st$ > "12" then goto L30360
/*<AWD017>*/ if sc_sel% <> 3% or dt_st$ <> "15" then goto L30343
L30342:
            des_bar$ = dt_bar$
            if dt_st$ = "15" then goto L30360   
            gosub check_scanned_rga
...
L30347: 
            message$ = "1 dept = " & dt_dept$ & ", st = " & dt_st$
...
L30350:        if str(sc_dept$,1%,3%) = "ALL" and dt_dept$ = "001"     ~
               ...
               if (dt_st$ = "15" and rga_dept% > 0) then       ~
                  nn%(rga_dept%,tt%) = nn%(rga_dept%,tt%) + 1%        ~
               else nn%(xx%,tt%) = nn%(xx%,tt%) + 1% /* Not Scanned Windows,*/

REM            nn%(xx%,tt%) = nn%(xx%,tt%) + 1% /* Not Scanned Windows,*/

L30355:        dt_st_d$ = "*Sched*"
               goto L30490                       /* Sashs, Parts By Dept*/
                                                /* Scanned Values      */
L30360:                                                                   
/*AWD000*/  if sc_sel% = 3% and sc_dept$ = "032" then xx% = 1% 
            message$ = "3 dept = " & dt_dept$ & ", st = " & dt_st$
REM	    call "LOGFILE" (message$)
...
L60440:    /* read apcplnad looking for status 15 records */
	     ...
	     tmp2$ = str(dt_rec$,24,18)
   	   ...
   	   if str(des_key$,19%,6%) > ed_dte$ then goto L60440
           if des_st$ <> "15" and str(des_key$,25,3) <> "032" then goto L60440
           des_sw = 1.0
L60441:    return
...
REM                 if mod(dt_sc%,2%) = 0% then dt_sc% = 1% else dt_sc% = 2%
...
L42050:     gosub set_pf2
            accept                                                       ~
               ...
               at (09,02),                                               ~
                  " ----- ------------------------- ------------------",~
               at (08,54),                                               ~
                  "Cust.  Load  Prd Dte  PLoad",                                   /* (Y2K, LDJ) */~
               at (09,54),                                               ~
                  "------ ----- -------- -----",                                  /* (Y2K, LDJ) */~
/*(EWD006)*/   at (10,01), fac(hex(84)), bo$(i%  )              , ch(01),~
               ...
               at (10,67), fac(hex(84)), c6$(i%  )              , ch(08),       /* (Y2K, LDJ) */~
...
/*(EWD006)*/   at (11,01), fac(hex(84)), bo$(i%+1%)             , ch(01),~
               ...
               at (11,67), fac(hex(84)), c6$(i%+1%)             , ch(08),       /* (Y2K, LDJ) */~
...
/*(EWD006)*/   at (12,01), fac(hex(84)), bo$(i%+2%)             , ch(01),~
               ...
               at (12,67), fac(hex(84)), c6$(i%+2%)             , ch(08),       /* (Y2K, LDJ) */~
...
/*(EWD006)*/   at (13,01), fac(hex(84)), bo$(i%+3%)             , ch(01),~
               ...
               at (13,67), fac(hex(84)), c6$(i%+3%)             , ch(08),       /* (Y2K, LDJ) */~
...
/*(EWD006)*/   at (14,01), fac(hex(84)), bo$(i%+4%)             , ch(01),~
               ...
               at (14,67), fac(hex(84)), c6$(i%+4%)             , ch(08),       /* (Y2K, LDJ) */~
...
/*(EWD006)*/   at (15,01), fac(hex(84)), bo$(i%+5%)             , ch(01),~
               ...
               at (15,67), fac(hex(84)), c6$(i%+5%)             , ch(08),       /* (Y2K, LDJ) */~
...
/*(EWD006)*/   at (16,01), fac(hex(84)), bo$(i%+6%)             , ch(01),~
               ...
               at (16,67), fac(hex(84)), c6$(i%+6%)             , ch(08),       /* (Y2K, LDJ) */~
...
/*(EWD006)*/   at (17,01), fac(hex(84)), bo$(i%+7%)             , ch(01),~
               ...
               at (17,67), fac(hex(84)), c6$(i%+7%)             , ch(08),       /* (Y2K, LDJ) */~
...
/*(EWD006)*/   at (18,01), fac(hex(84)), bo$(i%+8%)             , ch(01),~
               ...
               at (18,67), fac(hex(84)), c6$(i%+8%)             , ch(08),       /* (Y2K, LDJ) */~
...
/*(EWD006)*/   at (19,01), fac(hex(84)), bo$(i%+9%)             , ch(01),~
               ...
               at (19,67), fac(hex(84)), c6$(i%+9%)             , ch(08),       /* (Y2K, LDJ) */~
...
/*AWD014*/  if sc_sel% = 3% and sc_dept$ = "032" then xx% = 1%    
            if sc_sel% > 2% and sc_sel% < 5% then goto L43700
               ...
               x2% = nn%(xx%,2%)                             /* Sashs  */
               x3% = nn%(xx%,3%)                             /* Parts  */
              if sc_sel$ <> "1" or sc_dept$ <> "032" then                  ~
                    goto L43550
               x1% = nn_tot%(1)
               x2% = nn_tot%(2)
               x3% = nn_tot%(3)
...
L44880:        close ws
        ...
        set_pf3
            init(" ") txt$(), inpmessage$
            if sc_sel% = 3% and sc_dept$ = "032" then goto L44888
...
not_2:
           ...
           if dt_sc% <> 3% then goto not_3
              str(dt_key$,1%,57%) = str(dt_rec$,1%,23%)
                 if str(dt_key$,1%,5%) > ed_load$ then goto calc_scanned_done
not_3:

           if sc_sel$ = "1" and sc_dept$ = "032" then goto L62910 
/*@@@*/    if sc_sel$ = "3" and sc_dept$ = "032" then goto L62910 
...
L62920:    REM  call "SHOSTAT" ( " I am here at status check " ) 
          convert p_scan% to p_scan$, pic (##)
           if sc_sel$ = "1" and sc_dept$ = "032" then goto L62930 
/*@@@*/    if sc_sel$ = "3" and sc_dept$ = "032" then goto L62930 
           if p_scan% = 0% and str(dt_rec$,64%,2%) < "12" then goto L62940
REM           if p_scan% = 1% and (str(dt_rec$,64%,2%) > "11" and            ~
           ...
           if p_scan% = 3% and str(dt_rec$,64%,2%) < "13"                    ~
                  then gosub check_inline
           if p_scan% = 3% and str(dt_rec$,64%,2%) < "13" and                ~
                  inline% = 0% then goto L62940
		  /* <AWD014> */      
L62930:    /* && st = "15"? */                                     
           if sc_sel$ = "1" and str(dt_rec$,64%,2%) = "15" then goto L62932
           if sc_sel$ = "1" and sc_dept$ = "032" then goto L62935
           if sc_sel$ = "3" and str(dt_rec$,64%,2%) = "15" then goto L62932
/*@@@*/    if sc_sel$ = "3" and sc_dept$ = "032" then goto L62935
           goto calc_scanned_nxt

/* <AWD015> */ 
L62932:     if sc_dept$ <> "ALL" and sc_dept$ <> "032" then ~
		goto calc_scanned_nxt
/* </AWD015> */ 
L62935:    if str(dt_rec$,42,3) = "032" and str(dt_rec$,64,2) < "12" then goto L63100
           if str(dt_rec$,64,2) = "15" then goto L63100
...
L63100:     if str(sc_load$,1%,3%) <> "ALL" or sc_id$ = "AL" then goto L63260
            init(" ") ad_time$, ad_dte$
...
L62240:     convert j1% to str(jdate1$,5%,3%), pic(000)                         /* (Y2K, LDJ) */
	   ...
	   /* AWD014 */
   if sc_sel$ = "1" and sc_dept$ = "032" then goto calc_scanned_first_all
   if sc_sel$ = "3" and sc_dept$ = "032" then goto calc_scanned_first_all
	  ...
	  if sc_dept$ = "031" and sc_sel$ = "3" then goto calc_scanned_first_all
...
/*AWD014*/ if sc_sel$ = "1" and sc_dept$ = "032" then goto L62715
/*AWD014*/ if sc_sel$ = "3" and sc_dept$ = "032" then goto L62715
...
/* <AWD014> */    
L62720:   if sc_sel$ = "1" and sc_dept$ = "032" then goto L62722
          if sc_sel$ = "3" and sc_dept$ = "032" then goto L62722
          goto L62755
L62722:
            for i% = 1% to supp_max%                     /* Find Dept. */
                if ad_dept$ = supp$(i%) then goto calc_scanned_nxt_all      
            next i%
          if ad_st$ = "15" then goto L62815
          if sc_sel$ = "1" and ad_st$ < "12" and ad_dept$ = "032" ~
						  then goto L62815
          if sc_sel$ = "3" and ad_st$ > "15" and ad_dept$ = "032" ~
						  then goto L62815
	  goto calc_scanned_nxt_all
/* </AWD014> */

L62755:    if p_scan% <> 0% then goto L62795
                                                        /* Not Scanned */
...
L62815:    init(" ") dt_key$, dt_rec$
           ...
           if str(sc_load$,1%,3%) = "ALL" then goto L62925
              if str(dt_rec$,1%,5%) < sc_load$ or                        ~
                 str(dt_rec$,1%,5%) > ed_load$ then goto calc_scanned_nxt_all
/* <AWD014> */     
L62925:    if sc_sel$ = "3" and sc_dept$ = "032" then goto L62945  
           if sc_sel$ <> "1" or sc_dept$ <> "032" then goto L62927
            for i% = 1% to supp_max%                     /* Find Dept. */
               if str(dt_rec$,42,3) = supp$(i%) then goto calc_scanned_nxt_all  
            next i%
           if str(dt_rec$,42,3) = "032" and str(dt_rec$,64,2) < "12" then  ~
	          goto L62945
/* <AWD015> */ 
            if sc_dept$ <> "ALL" and sc_dept$ <> "032" then       ~
                         goto calc_scanned_nxt_all      
/* </AWD015> */ 
           if str(dt_rec$,64,2) = "15" then goto L62945
           goto calc_scanned_nxt_all      
/* </AWD014> */

L62927:    if p_scan% <> 0% then goto L62945     /* Goto Scanned Product*/
              if str(dt_rec$,64%,2%) > "11" then goto calc_scanned_nxt_all
L62945: REM INIT(" ") DB$
...
L63125:
           if xx_dte$ > ee_dte$ then goto calc_scanned_done_all
            ...
            if xx_dte$ = ee_dte$ then goto L63235          
                                                ...
                                                /* All of 1st and 2nd  */
                                                /* part of 3rd shift   */
               if ap$ = "PM" then goto L63265
               if hr% < 7% or hr% = 12% then goto calc_scanned_nxt_all
                  goto L63265                    /*Check Next Day Second*/
                                                /*Only last part of 3rd*/
                                               /*shift.Midnight to 7 AM*/
L63235:     if ap$ = "PM" then goto calc_scanned_nxt_all
            if hr% < 7% or hr% = 12% then goto L63265    /* Midnight to */
