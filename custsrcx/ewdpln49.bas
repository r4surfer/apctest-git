        REM *************************************************************~
            ...
            *                                                           *~
            *  Subroutine Used   - EWDPLO49 (Print Bulk Label)          *~
            *                                                           *~
            *  Special Comments  -                                      *~
            *                                                           *~
            *-----------------------------------------------------------*~
            ...
            *10/19/2021! CR2802 Black laminate for 150 series     | RDB *~
...
L11120:     fieldnr% = cursor%(1%) - 3%
            ...
            if cursor%(1%) = 10% then fieldnr% = cursor%(1%) - 7%
...
/* confirm model, color and grid match with sku table  */    
            if str(lb_part$,1%,3%) = "N54" then goto L27000     
            if str(lb_part$,1%,4%) <> str(part$,1%,4%) then goto load_next_rec
L27000:     if str(lb_part$,2%,4%) <> str(part$,2%,4%) then goto load_next_rec
...
/* CR3017 */          
          ...
          if sizewrong% = 1% then goto load_next_rec
          
            cnt% = cnt% + 1%

            call "EWDPLO49" (been_here%, lb_rec$(), #4, #1, #6, #63, #7,    ~
                 #8, sc_sku$, upc$, sc_qty%, lb_wd_nrw$, sc_sel_p$, err%)
        ...
        load_done
            ...
            call "EWDPLO49" (been_here%, lb_rec$(), #4, #1, #6, #63, #7,    ~
                 #8, sc_sku$, upc$, sc_qty%, lb_wd_nrw$, sc_sel_p$, 99%)
                if err% <> 0% then gosub print_error
...
L40190:     accept                                                       ~
               ...
               at (02,02), fac(hex(94)), errormsg$              , ch(79),~
                                                                         ...
                                                                         ~
               at (04,02), "SKU Number        :",                        ~
               at (04,25), fac(lfac$(1%)), sc_sku$              , ch(10),~
               at (04,40), fac(hex(84)),   sc_desc$             , ch(30),~
               at (05,40), fac(hex(84)),   sc_grid$             , ch(30),~
               at (06,40), fac(hex(84)),   sc_color$            , ch(30),~
                                                                         ~                                                           
               at (07,02), "Quantity to print :",                        ~
               at (07,25), fac(lfac$(2%)), sc_qty$              , ch(05),~
                                                                         ~
               at (10,02), "Printer           :",                        ~
               at (10,25), fac(lfac$(3%)), sc_sel_p$            , ch(01),~
                                                                         ~
...
L50300:     if sc_sel_p$ = " " then sc_sel_p$ = "1"
            convert sc_sel_p$ to sc_sel_p%, data goto L50350

            convert sc_sel_p% to sc_sel_p$, pic(0)

            if sc_sel_p$ < "1" or sc_sel_p$ > "2" then goto L50350
        return

L50350:    errormsg$ = "(Error) Invalid Printer Number (1 or 2)"
           gosub error_prompt
           init(" ") sc_sel_p$
        return
