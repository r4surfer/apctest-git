        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            ...
            * 01/25/18 ! CR1291 add email address to the screen   ! RDB *~
        ...
        dim                                                              ~
            ...
            emailaddr$50,                /* CR1291 email address       */~
        ...
        inputmode
            init(" ") errormsg$, inpmessage$, salesman$, name$, addr$(), ~
                      phone$, str(line2$,,60), vf$, emailaddr$      /* CR1291 */
...
/* CR1291 */
            get #1 using L14270, salesman$, name$, addr$(), phone$, emailaddr$
L14270:         FMT CH(4), CH(30), 3*CH(30), CH(10), POS(335), CH(50)
            section% = 0%
            if line% > 51% then gosub page_heading
            phonefmt$ = str(phone$,,3) & "-" & str(phone$,4,3) & "-" &   ~
                        str(phone$, 7)
/* CR1291 */
            print using L15020, salesman$, name$, addr$(1),phonefmt$, emailaddr$
...
L20280
*        Default/Enable for Email Address
            inpmessage$ = "Enter Salesman's Email Address."
            return
...
L40400: accept                                                           ~
            ...
            at (11,34), "-",   at (11,40), "-",                          ~
/* CR1291 */                                                             ~
            at (12,02), "Email Address",                                 ~
            at (12,30), fac(lfac$( 5)), emailaddr$              , ch(50),~
                                                                         ~
