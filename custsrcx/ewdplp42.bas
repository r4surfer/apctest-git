        REM *************************************************************~
            ...
            *                                                           *~
            *  Subroutine Used   - EWDPLP42 (Print Production Labels)   *~
            ...
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            *11/24/2008! (New) Program - Copied & Mod EWDPLN42.   ! DES *~
            *08/01/2014! (Cloned) for new Lowes Stock Labels      ! PWW *~
            *01/15/2015!          Mod to use AWDPCMST.            ! PWW *~
            *05/18/2020! CR2563   Add sequence range option       ! RDB *~
            *04/13/2021! CR2816   Call new stock label print      ! RDB *~
            *05/20/2021! CR2837   Bug in printing after CR2816    ! RDB *~
            *************************************************************
        ...
        REM *************************************************************~
            ...
            *************************************************************
            dim apc$40, pname$21                            /* (AWD023) */
                                                            ...
                                                            /* (PAR003) */
                                                            /* (PAR004) */
            apc$   = "Generate Production Labels- 11-24-2008"
            pname$ = "EWDPLP42 - Rev: R1.00"
...
/* CR2816 */          if keyhit% = 5% and fieldnr% = 1% then goto run_program
...
L11180:     sc_sel_p$ = "1"
            if sc_sel% >= 1 and sc_sel% <= 2 then sc_sel_p$ = "2"
            if sc_sel% >= 6 and sc_sel% <= 9 then sc_sel_p$ = "2"
            if sc_sel% >= 15 and sc_sel% <= 20 then sc_sel_p$ = "2"
            enabled% = 1%
        return
...
REM     @@@@@@@@ add sc_sel$ so it can filter by label type.....
            call "EWDPLO42" (been_here%, lb_rec$(), #4, #1, #6, #63, #7, ~
...
L40190:     accept                                                       ~
               ...
               at (13,40), "      15 = Series 85 SH",                    ~
               at (14,40), "      16 = Series 85 SH w/grid",             ~
               at (15,40), "      17 = Series 85 SH Bronze",             ~
               at (16,40), "      18 = Series 85 SH w/grid Bronze",      ~
               at (17,40), "      19 = Series 85 Slider",                ~
               at (18,40), "      20 = Series 151 Slider",               ~
/*SR70000*/    at (19,40), "      21 = Series 130 Slider",               ~
/* vacant      at (20,40), "      20 =                                 */~
...
L50350:    errormsg$ = "(Error) Invalid Label Type (1-20)"
           gosub error_prompt
           init(" ") sc_sel$
        return
