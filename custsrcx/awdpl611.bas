        REM *************************************************************~
            ...
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            *04/29/2009! (New) Program For editing kanbanms       ! DES *~
            *************************************************************
        ...
        REM *************************************************************~
            ...
            *************************************************************
            ...
            pname$ = "AWDPL611 - 02/09/2009"              /* (AWD004)  */
...
delete_rec:  
	str(aes_key$,26,6) = aes_seq$       
   	read #1, key 0% = aes_seq$, hold, USING KANBANFMT,              ~  
...
L40190:     accept                                                       ~
               ...
               at (06,20), fac(lfac$(4%)), aes_qty$             , ch(07),~
                                                                         ~
               at (07,02), "POUR:                 ",                     ~
               at (07,25), fac(lfac$(5%)), aes_pour$            , ch(06),~
                                                                         ~
...
L50080: Rem Sequence Number                                       
        ...
        if aes_seq% > 4999% then goto L50085
