        REM *-----------------------------------------------------------*~
            *                                                           *~
            * AAAAAA  W   W DDDD   EEEE  DDDD  IIIIII    1     777777   *~
            * AA  AA  W   W DD  D  EE    DD  D   II     11     7    7   *~
            * AAAAAA  W W W DD  D  EEEE  DD  D   II      1         7    *~
            * AA  AA  WW WW DD  D  EE    DD  D   II      1         7    *~
            * AA  AA  W   W DDDD   EEEE  DDDD  IIIIII  11111      7     *~
            *-----------------------------------------------------------*~
            * AWDEDI17 - Create Flat File To Send To IPNET              *~
            *-----------------------------------------------------------*~
            *                  M O D I F I C A T I O N S                *~
            *---WHEN-----+--------------WHAT----------------------+-WHO-*~
            * 02/22/2007 ! Copied from awdedi04 for 84 Lumber     | DES *~
            *-----------------------------------------------------------*
        ...
        REM *************************************************************~
            ...
            *-----+----------+------------------------------------------*~
            * #1  ! APCEDI84 ! AWD EDI Master IBSA File              *~
            * #3  ! GENCODES ! GENCODES Table File                      *~
            * #4  ! AWD84SEN ! EWD IPNet Send Flat File                 *~
            *************************************************************~
