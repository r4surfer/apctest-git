REM         *-----------------------------------------------------------*~
            *                                                           *~
            * AAAAAA  W   W DDDD   EEEE  DDDD  IIIIII   0000    666     *~
            * AA  AA  W   W DD  D  EE    DD  D   II    0    0  6        *~
            * AAAAAA  W W W DD  D  EEEE  DD  D   II    0    0  6666     *~
            * AA  AA  WW WW DD  D  EE    DD  D   II    0    0  6   6    *~
            * AA  AA  W   W DDDD   EEEE  DDDD  IIIIII   0000    666     *~
            *-----------------------------------------------------------*~
        ...
        REM *************************************************************~
            ...
            *-----+----------+------------------------------------------*~
            * #1  ! APCEDIST ! AWD EDI Master IBSA File              *~
            * #3  ! GENCODES ! GENCODES Table File                      *~
            * #4  ! AWDSTSEN ! EWD IPNet Send Flat File                 *~
            *************************************************************~
...
L01270:    edi% = 0%
        ...
        build_invoice_recs
           ...
           init(hex(00)) apcmc_key$
           str(apcmc_key$,1,2)="SI"
REM        apcmc_key$="SI"
REM        str(apcmc_key$,3,20)=hex(00)
...
L02890:            FMT CH(8), CH(6), CH(6), CH(4), CH(39), CH(173)
        ...
        detail_ipn
	  yard$ = "      "
          if str(detail_send_unpk$,1,1) = "B" then yard$ = edi_cust$
          str(detail_send_unpk$,218%,4%) = "    "
          put #4, using L01620, detail_send_unpk$, yard$    
L01620:          FMT CH(226), CH(06)
