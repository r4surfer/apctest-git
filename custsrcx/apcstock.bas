        REM *************************************************************~
            *   Note - HNYMASTR and HNYQUAN (Not Changed)               *~
            *                                                           *~
        ...
        dim                                                              ~
            stk_key$52,                  /* Stock Key          (PAR000)*/~
            stk_part$25,                 /* Part Number                */~
            stk_sub_part$20,             /* New Sub Part Number(PAR000)*/~      
            stk_bin$5,                   /* BIN Location               */~
            stk_level$2,                 /* Level within BIN           */~
            stk_descr$30,                /* BIN Description            */~
            stk_filler$39,               /* Filler area        (PAR000)*/~
        ...
        REM *************************************************************~
            ...
            *************************************************************
            dim cms2v$50
            cms2v$ = "01.01.01 01/01/06 EWD New Program                "
        REM *************************************************************
        ...
        REM *************************************************************~
            ...
            * #2  ! EWDSTOCK ! Stock Location for Standard Products     *~
            *     !          !   Replace old file 'APCSTOCK'            *~ 
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        scrn1_msg  :  data                                               ~
         ...
         "Enter a Valid MFG OR Raw Material Part Number, Plus Sub.     ",~
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        dataload
          ...
          str(stk_key$,33%,20%) = stk_sub_part$
          read #2,key = stk_key$,using L35040, stk_bin$, stk_level$,     ~
                        stk_part$, stk_sub_part$, stk_bin$, stk_level$,  ~
                        stk_descr$, stk_filler$, eod goto L30130
          rec% = 1%                                         /* ON FILE  */
L30130: return                                              /* (PAR000) */
        ...
        dataput
          ...
          call "SHOSTAT" ("Updating ("&stk_part$&stk_sub_part$&")")
          str(stk_key$,1%,5%)   = stk_bin$
          str(stk_key$,6%,2%)   = stk_level$
          str(stk_key$,8%,25%)  = stk_part$
          str(stk_key$,33%,20%) = stk_sub_part$
...
L31120:   write #2, using L35040, stk_bin$, stk_level$, stk_part$,       ~
                            stk_sub_part$, stk_bin$, stk_level$,         ~
                            stk_descr$, stk_filler$
                                                        /* (PAR000)     */
        return clear all
        goto inputmode
...
L40220:     accept                                                       ~
               ...
               at (08,50), "Sub:",                                       ~
               at (08,55), fac(Lfac$(3%)), stk_sub_part$        , ch(20),~
                                                                         ~  
               at (09,02), "BIN Descript:",                              ~
               at (09,20), fac(lfac$(4%)), stk_descr$           , ch(32),~
               at (11,02), "Part Descr  :",                              ~
               at (11,20), fac(hex(84)), part_desc$             , ch(32),~                            
                                                                         ~
...
L50500:       FMT POS(26), CH(32)
           ...
           if len(stk_sub_part$) < 5 then stk_sub_part$ = "00000                    "
...
L50570:     errormsg$ = "(Error)-Invalid MFG or Raw Material Part No."
            init(" ") stk_part$, part_desc$, stk_sub_part$
...
L60120:     page_no% = 0%
        ...
        delete_part
          ...
          str(stk_key$,6%,2%)  = stk_level$
          str(stk_key$,8%,25%) = stk_part$
          str(stk_key$,33%,20%)= stk_sub_part$        /* (PAR000)     */
...
L60750:   rec% = 0%
        ...
        rpt_1_next
            read #2,key > stk_key$,using L35040,stk_bin$, stk_level$,     ~
               stk_part$, stk_sub_part$, stk_bin$, stk_level$,stk_descr$, ~
                                                      eod goto rpt_1_done
            str(stk_key$,1%,5%)   = stk_bin$
            str(stk_key$,6%,2%)   = stk_level$
            str(stk_key$,8%,25%)  = stk_part$
...
L61060: rpt_2_next
            ...
            str(stk_key$,26%,20%) = stk_sub_part$
            str(stk_key$,46%,5%)  = stk_bin$
            str(stk_key$,51%,2%)  = stk_level$
