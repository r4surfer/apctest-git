        REM *************************************************************~
            ...
            *                                                           *~
            * AWDVLRPT - (EWD) Version of Report Uses the Old Format    *~
            *-----------------------------------------------------------*~
            ...
            * 03/09/06 ! Modification for INV files               ! CMG *~
            *************************************************************~
        ...
        dim                                                              ~
            ...
            firstpart$45,                /* FIRST PART NUMBER IN RANGE */~
            ...
            lastpart$45,                 /* LAST PART NUMBER IN RANGE  */~
            last_part_printed$45,        /* LAST PART NUMBER PRINTED   */~
            ...
            newreadkey$63,               /* READ KEY FOR WORK FILE     */~
            oldquankey$64,               /* USED IN PLOW ON HNYQUAN    */~
            partnr$45,                   /* THIS PART NUMBER           */~
        ...
        REM *************************************************************~
            ...
            *-----+----------+------------------------------------------*~
            * # 2 ! INVMASTR ! INVENTORY MASTER FILE                    *~
            * # 3 ! INVQUAN  ! INVENTORY STORE QUANTITY DETAIL FILE     *~
            ...
            *************************************************************
            ...
            select #3,  "INVQUAN",                                       ~
                        ...
                        recsize = 768,                                   ~
                        keypos = 17, keylen = 64,                        ~
                        alternate key 1, keypos =  1, keylen = 64
...
REM             call "OPENCHCK" (#file%, cmg%, cmg1%, 100%, cmg$)
...
L15210:     FMT POS(17), CH(45), CH(3), CH(6), POS(89), 5*PD(14,4),      ~
                         POS(137), PD(14,4), POS(279), CH(9),            ~
                         POS(423), CH(1)
...
REM            prtvar$(1) = "  LOT NUMBER" & lot$
            prtvar$(1) = str(partnr$,25,20)
            prtvar$(2) = " "
            linenumber%(1) = 2
            return
...
L40170:     accept                                                       ~
               ...
               at (07,04),                                               ~
                  "First Store",                                         ~
               at (07,15), fac(lfac$( 1)), firststore$          , ch(03),~
               at (07,23),                                               ~
                  "First Part",                                          ~
               at (07,34), fac(lfac$( 3)), firstpart$           , ch(45),~
               at (08,04),                                               ~
                  "Last Store",                                          ~
               at (08,15), fac(lfac$( 2)), laststore$            ,ch(03),~
               at (08,23),                                               ~
                  "Last Part",                                           ~
               at (08,34), fac(lfac$( 4)), lastpart$             ,ch(45),~
               at (11,02),                                               ~
        ...
        print_page_heading
            ...
            if file% = 6 then L60380
                ...
                if f1%(4) = 1 then L60300
                    ...
                    str(pf1$,17,61) = "For Part Number " & partnr$
...
L60380:     call "GLUNFMT" (account$)
            ...
            if f1%(7) = 1 then L60500
                ...
                str(pf1$,25,61) = "For Part Number " & partnr$
