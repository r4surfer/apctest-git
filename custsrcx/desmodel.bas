...
REM	    if (str(apckey$,2,4) = "0000") then goto L01000 
	    ...
	    if (Model$ = "210") then goto process 
	    if (Model$ = "213") then goto process 
	    if (Model$ = "214") then goto process 
	    if (Model$ < "209") then str(apckey$,8,3) = "209" 
	    if (Model$ > "214") then str(apckey$,8,3) = "ZZZ" 
	    goto L01000
process:    key$ = apckey$
            gosub L02000
            goto L01000
