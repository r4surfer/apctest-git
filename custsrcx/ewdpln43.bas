        REM *************************************************************~
            *  Program Name      - EWDPLN43  - clone EWDPLN42           *~
            *  Creation Date     - 10/24/2018                           *~
            *                                                           *~
            *  Description       - Production McCoy Labels Printing.    *~
            ...
            *                                                           *~
            *  Subroutine Used   - EWDPLS43 (Print Production Labels)   *~
            ...
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            *05/14/2020! CR2544 Add Sequence Range printing       ! RDB *~
			*03/10/2023! CR3273 New black 150 series SH           ! RDB *~
            *07/03/2023! CR3344 New V clay color                  ! RDB *~
            *************************************************************
        ...
        dim                                                              ~
            ...
            sc_clr$1,sc_clr_d$30,        /* Color Code and description */~
            sc_seq_fr$5,                 /* Beginning Sequence  CR2544 */~
            sc_seq_to$5,                 /* Ending Barcode      CR2544 */~ 
        ...
        REM *************************************************************~
            ...
            *************************************************************
            ...
            apc$   = "Generate Production Labels- 10-24-2018"
            pname$ = "EWDPLN43 - Rev: R1.00"
...
L10230:         gosub'151(fieldnr%)     /* Edit Field for Valid Entry */
        ...
        editpg1
            ...
            gosub'101(0%, 2%)           /* Display Screen - No Entry   */
                  if keyhit%  =  1% then gosub startover
                  if keyhit%  = 16% and sc_sel$ = "  " then gosub'151(fieldnr%)
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        scrn1_msg  :  data                                               ~
         ...
         "Enter a Color Code?  2, Q, ' '                               ",~
         "Enter a Label Type (1 - 21)'                                 "
/* CR3273 label type to 21 */
        REM *************************************************************~
...
/* CR2544 */
            init(" ") errormsg$, inpmessage$, sc_dept$, sc_dept_d$,      ~
                      ...
                      sc_end_prddate$, sc_sel$, sc_clr$, sc_clr_d$,      ~
                      sc_seq_fr$, sc_seq_to$
           
           sc_clr_d$ = "* Only applies to Series 300"
           lbl% = 0%
        return
...
/* CR2544 */
REM            if lb_shift$ <> sc_shift$ and sc_shift$ <> "AA"              ~
REM                then goto load_next_rec
...
L30025:     if (lb_seq$ < sc_seq_fr$ or lb_seq$ > sc_seq_to$)        ~
               ...
               if len(lb_part$) < 19% then goto load_next_rec 
               
            err% = 0%
REM     @@@@@@@@ add sc_sel$ so it can filter by label type.....
            call "EWDPLS43" (been_here%, lb_rec$(), #4, #1, #6, #63, #7, ~
                 #8, sc_sel$, sc_clr$, lbl%, err%)
...
L35040:     FMT 4*CH(256)
        ...
        deffn'101(fieldnr%, edit%)
              ...
              on fieldnr% gosub L40170,      /* sc_prddate$             */~
                                ...
                                L40160,      /* sc_seq_fr$ _to$ CR2544  */~
                                L40160,      /* sc_clr$                 */~
                                L40160       /* sc_sel$ label type      */
              goto L40190
...
L40190:     accept                                                       ~
               ...
               at (03,23), fac(lfac$(1%)), sc_prddate$          , ch(10),~
               at (03,40), fac(lfac$(1%)), sc_end_prddate$      , ch(10),~
                                                                         ~
               at (04,02), "Dept. Code       :",                         ~
               at (04,23), fac(lfac$(2%)), sc_dept$             , ch(03),~
               at (04,40), fac(hex(84)),   sc_dept_d$           , ch(30),~
                                                                         ~
               at (05,02), "Load No. Range   :",                         ~
               at (05,23), fac(lfac$(3%)), sc_load_fr$          , ch(05),~
               at (05,45), fac(lfac$(3%)), sc_load_to$          , ch(05),~
                                                                         ~
               at (06,02), "Barcode No. Range:",                         ~
               at (06,23), fac(lfac$(4%)), sc_barcode_fr$       , ch(18),~
               at (06,45), fac(lfac$(4%)), sc_barcode_to$       , ch(18),~
                                                                         ~
               at (07,02), "Sequence No Range:",                         ~
               at (07,23), fac(lfac$(5%)), sc_seq_fr$           , ch(05),~
               at (07,45), fac(lfac$(5%)), sc_seq_to$           , ch(05),~
                                                                         ~
               at (08,02), "Color            :",                         ~
               at (08,23), fac(lfac$(6%)), sc_clr$              , ch(01),~
               at (08,30), fac(hex(84)),   sc_clr_d$            , ch(30),~
                                                                         ~    
               at (09,02), "Label Type       :",                         ~
               at (09,23), fac(lfac$(7%)), sc_sel$              , ch(02),~
               at (09,27), "McCoy Series only",                          ~
                                                                         ~                                                  
               at (10,02), "      01 = Series 130 SH",                   ~
               at (09,44), "      11 = Series 300 SL",                   ~
               at (11,02), "      02 = Series 130 SH w/grid",            ~
               at (10,44), "      12 = Series 300 SL w/grid",            ~
               at (12,02), "      03 = Series 130 SL",                   ~
               at (11,44), "      13 = Series 5700 SH",                  ~
               at (13,02), "      04 = Series 130 SL w/grid",            ~
               at (12,44), "      14 = Series 5700 SH w/grid",           ~  
               at (14,02), "      05 = Series 160 SH",                   ~
               at (13,44), "      15 = Series 5700 SL",                  ~
               at (15,02), "      06 = Series 160 SH w/grid",            ~
               at (14,44), "      16 = Series 8300 DH",                  ~
               at (16,02), "      07 = Series 161 SL",                   ~
               at (15,44), "      17 = Series 8300 SL",                  ~             
               at (17,02), "      08 = Series 161 SL w/grid",            ~
               at (18,02), "      09 = Series 300 SH",                   ~
               at (19,02), "      10 = Series 300 SH w/grid",            ~
/* CR3273 */ ~			   
               at (16,44), "      18 = Series 150 SH Black",             ~
               at (17,44), "      19 = Series 150 SH w/grid Black",      ~
               at (18,44), "      20 = Series 150 SL Black",             ~
               at (19,44), "      21 = Series 150 SL w/grid Black",      ~			   
                                                                         ~
...
REM CR2544 L50080 Rem Enter a Shift Code                      sc_shift$
REM            if sc_shift$ <> " " then goto L50083
REM            sc_shift$ = "AA"
REM            return 

REM L50083     convert sc_shift$ to sc_shift%, data goto L50850
REM            convert sc_shift% to sc_shift$, pic(00)
REM            gosub check_shift
REM            if shft% = 0% then goto L50850
REM            return 
REM            
REM L50850     errormsg$ = "(Error) Invalid Shift"
...
L50257:     if str(sc_seq_fr$,1%,3%) <> "ALL" then goto L50259
               sc_seq_to$ = "ALL  "
               return
...
L50275:     init (" ") sc_clr_d$
            if sc_clr$ = " " and sc_sel$ = " " then return
            
            if sc_sel$ = " " then goto L50280
            
            convert sc_sel$ to sc_sel%, data goto L50350
            convert sc_sel% to sc_sel$, pic(00)
            if sc_clr$ = " " and (sc_sel$ >= "09" and sc_sel$ <= "12") then ~
                 goto L50287
            
L50280:     if sc_clr$ = " " then return 
            r% = pos("2QV" = sc_clr$)           /* new clay CR3344 */    
            if r% = 0% then goto L50285
            gosub check_color
            if clr% = 0% then goto L50285
            sc_clr_d$ = desc$
        return                 
L50285:    errormsg$ = "(Error) Invalid Color Code"
           gosub error_prompt
           init(" ") sc_clr$, sc_clr_d$
        return
L50287:    errormsg$ = "(Error) Color Required for Label Type"
           gosub error_prompt
        return
...
L50300:
            ...
            if sc_sel$ < "01" or sc_sel$ > "21" then goto L50350 
            
            if (sc_sel% >= 9% and sc_sel% <= 12%) and sc_clr$ = " " then ~
                   goto L50302              /* Default 300 series */   
...
L50350:    errormsg$ = "(Error) Invalid Label Type (1-21)"   /* CR3273 */
           gosub error_prompt
           init(" ") sc_sel$
        return      
...
L51010: return
        ...
        check_shift
            ...
            str(readkey$,10%,15%) = sc_shift$
            read #4,key = readkey$, using L51300, desc$, eod goto L51310
L51300:        FMT POS(25), CH(30)
            shft%= 1%
L51310: return
        ...
        check_color
            ...
            str(readkey$,10%,15%) = sc_clr$
            read #4,key = readkey$, using L51500, desc$, eod goto L51510
