...
/*      skip is not ref code 27 and rec cal method 000  */
            if (str(pc_rec$,19,2) <> "27") then goto L01000
            if (str(pc_rec$,21,3) <> "000") then goto L01000
/*      only mod following models                       */
            if (str(pc_rec$,13,3) = "378") then goto set_mdl    
            if (str(pc_rec$,13,3) = "388") then goto set_mdl    
            if (str(pc_rec$,13,3) = "358") then goto set_mdl    
            if (str(pc_rec$,13,3) = "368") then goto set_mdl    
            goto L01000
