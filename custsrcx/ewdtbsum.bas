        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *  EEEEE  W   W  DDDD   TTTTT  BBBB    SSS   U   U  M   M   *~
            *  E      W   W  D   D    T    B   B  S      U   U  MM MM   *~
            *  EEEE   W W W  D   D    T    BBBB    SSS   U   U  M M M   *~
            *  E      WW WW  D   D    T    B   B  D   D  U   U  M   M   *~
            *  EEEEE  W   W  DDDD     T    BBBB   DDDD    UUU   M   M   *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * EWDTBSUM - Prints Summary Trial Balance.                  *~
            *-----------------------------------------------------------*~
        ...
        dim                                                              ~
            ...
            billto(9), billto$(7)14,     /* Bill-to Aging and Print    */~
            ...
            division$4,                  /* Atrium Division Code       */~
...
L12320:                   % ###### -####
            if aging%(9) =  99999% then                                  ~
                     put hdrs$(6) using L12320, "  OVER", aging%(5)
...
*        Print Bill-to
            ...
            if f1%(3) = 0% then billtoname$ = "** NOT ON FILE **"   ~
                           else get #3 using L12550, terms$, division$
L12550:                    FMT POS(543), CH(20), POS(1069), CH(4)
            init(" ") billto$()
                ...
                next c%
            print using L13580, billto$, division$, terms$,               ~
                               billto$(1), billto$(2), billto$(3),       ~
                               billto$(4), billto$(5), billto$(6),  billto$(7)
            billtos% = billtos% + 1%
            line%    = line%    + 1%
            goto report_loop
...
L13513: %                                                         EXCLUDE~
        ~ G/L ACCOUNTS ############ THRU ############
L13520: % BILL-TO  DIVIS   TERMS         TOTAL DUE  #############  ######~
        ~#######  #############  #############  #############  #############
L13550: %--------- ----- ----------  -------------  -------------  ------~
        ~-------  -------------  -------------  -------------  -------------
L13580: %#########  ####  ########  ############## ############## #######~
