        REM *************************************************************~
            ...
            *                                                           *~
            *                                             (AWD004)      *~
            *  aes_prt_flg$   - 'A' = AES          'B' = AES backup     *~
            *                   'C' = Texas                             *~
            *                                                           *~
            *-----------------------------------------------------------*~
            ...
            *09/27/2011! (AWD008) changes for FT UOM              ! DES *~
            *11/29/2011! (AWD009) mod to make min qty 8 instd 10  ! CMG *~
            *02/24/2017! (SR79721) add user IVT                   ! CMN *~
            *04/04/2018! (CR1437) add 2 badge entries and print   ! RDB *~
            *02/12/2019! CR-1894  Increaded Emp Dept size         ! DES *~
            *************************************************************
        ...
        dim aes_po$16,                   /* Purchase Order Number      */~
            ...
            aes_bdg1$5,                  /* Badge 1   CR1437           */~
            aes_bdg2$5,                  /* Badge 2   CR1437           */~
            aes_prt_flg$1,               /* AES Prt Flag 1 or 2(AWD004)*/~
            aes_prt_flgd$10,             /* AES Prt Flag Descr (AWD004)*/~
            ...
            aes_rec$254, aes_rec_sav$254, /* Label Record    CR1437    */~
            aes_rec2$30, aes_rec2_sav$30, /* Label Record    CR1437    */~
...
/* CR1437 */
            call "OPENCHCK" (#14, fs%(14%), f2%(14%),200%, rslt$(14%))
...
/* <AWD005> */
            tm_part$(1,01) = "6115400489"
            tm_part$(1,02) = "6115600489"

            tm_part$(1,03) = "6115400490"
            tm_part$(1,04) = "6115600490"
            tm_part$(1,05) = "6115400491"
            tm_part$(1,06) = "6115600491"
            tm_part$(1,07) = "6115400496"
            tm_part$(1,08) = "6115600496"
            tm_part$(1,09) = "6115400361"
            tm_part$(1,10) = "6115600361"
            tm_part$(1,11) = "6115400362"
            tm_part$(1,12) = "6115600362"
            tm_part$(1,13) = "6115400362WL"
            tm_part$(1,14) = "6115600362WL"

            tm_part$(2,01) = "489W-16"
            tm_part$(2,02) = "489E-16"
            tm_part$(2,03) = "490W-W-16"
            tm_part$(2,04) = "490E-W-16"
            tm_part$(2,05) = "491W-W-16"
            tm_part$(2,06) = "491E-W-16"
            tm_part$(2,07) = "496W-16"
            tm_part$(2,08) = "496E-16"
            tm_part$(2,09) = "361W-W-16"
            tm_part$(2,10) = "361E-W-16"
            tm_part$(2,11) = "362W-W-16"
            tm_part$(2,12) = "362E-W-16"
            tm_part$(2,13) = "362W-16"
            tm_part$(2,14) = "362E-16"

            tm_part$(1,15) = "6115400380"
            tm_part$(1,16) = "6115600380"
            tm_part$(1,17) = "7125445144"
            tm_part$(1,18) = "7125645144"
            tm_part$(1,19) = "4105400394"
            tm_part$(1,20) = "4105600394"
            tm_part$(1,21) = "7125445035"
            tm_part$(1,22) = "7125645035"
            tm_part$(1,23) = "7125445005"
            tm_part$(1,24) = "7125645005"

            tm_part$(2,15) = "380W-W-16"
            tm_part$(2,16) = "380E-W-16"
            tm_part$(2,17) = "381W-16"
            tm_part$(2,18) = "381E-16"
            tm_part$(2,19) = "394W-16"
            tm_part$(2,20) = "394E-16"
            tm_part$(2,21) = "HMVW 165"
            tm_part$(2,22) = "HMVE 167"
            tm_part$(2,23) = "HMVW 166"
            tm_part$(2,24) = "HMVE 168"
...
/* <AWD005> */
        ...
        inputmode_1
        fieldcnt% = 6%                                      /* CR1437 */
            if aes_prt_flg$ = "A" or aes_prt_flg$ = "B" or                 ~
               aes_prt_flg$ = "C" then fieldcnt% = 6%       /* CR1437 */
...
L10240:         gosub'151(fieldnr%)     /* Edit Field for Valid Entry */
        ...
        editpg1
            ...
            gosub'101(0%, 2%)           /* Display Screen - No Entry   */
                  ...
                  if keyhit%  = 14% then gosub create_thermal_label
...
L14270:     gosub'103(fieldnr%, 2%)     /* Display & Accept Screen     */
        ...
        deffn'051(fieldnr%)
            enabled% = 1%
            if fieldnr% <= 6% then return                 /* CR1437 */

            if aes_prt_flg$ <> "A" and aes_prt_flg$ <> "B" and       ~
               aes_prt_flg$ <> "C" then return

            if fieldnr% = 1% then enabled% = 0%          /*  CR1437 */
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        scrn1_msg  :  data                                                ~
         ...
         "Enter Shift Code {A|B|C|D}?                                   ",~
         "Enter a Printer?                                              ",~
         "Enter Badge #1 or skip?                                       ",~
         "Enter Badge #2 or skip?                                       "
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        initialize_variables
            init(" ") errormsg$, inpmessage$, sc_raw_no$, sc_rack_qty$,   ~
                      ...
                      aes_awd_tme$, aes_awd_qty$, aes_awd_usr$,           ~
                      aes_date_line$, aes_ln_comp$, aes_ln_qty$,          ~
                      aes_recv$, aes_rcv_dte$, aes_rcv_tme$, aes_rcv_usr$,~
                      aes_fil$, aes_key$, aes_key1$, aes_key2$, aes_key3$,~
                      part_cat$, part_class$, part_type$, sc_available$,  ~
                      sc_raw$, sc_raw_d$, aes_scan_dte1$, aes_scan_tme1$, ~
                      aes_awd_dte1$, aes_awd_tme1$, aes_rcv_dte1$,        ~
                      aes_rcv_tme1$, status$, sc_serial$, current_avail$, ~
                      spec_errormsg$, aes_userid$, aes_user_name$,        ~
                      aes_time$, aes_shift$, aes_shift_desc$, aes_prt_flg$, ~
                      aes_prt_flgd$, aes_bdg1$, aes_bdg2$
/* CR1437 added other screen fields to initialize  */

            aes_userid$ = userid$
            aes_prt_default$ = "A"                        /* (AWD005)   */
            if userid$ = "TX1" then aes_prt_default$ = "C"
            if userid$ = "IVT" then aes_prt_default$ = "C" /*(SR79721)*/
        ...
        dataput
           init(" ") aes_key$, aes_rec$, rec$, dd$(), aes_rec2$
           rec% = 0%
           rec_fnd = 0
REM        gosub assign_serial_no
           ...
           read #1,hold,key 0% = aes_key$, using L30000, aes_rec$, aes_rec2$,  ~
                     eod goto L30010
L30000:        FMT CH(254), CH(30)                          /* CR1437 */
               rec_fnd = 1
               delete #1

               put #1, using L30000, aes_rec$, aes_rec2$
...
L30010:
           ...
           aes_oper$     = userid$
           str(aes_scan_dte$,1,1) = hex(00)
           str(aes_scan_dte$,2,5) = date
           aes_scan_tme$ = time$
           aes_scan_usr$ = aes_userid$
           ...
           put #1, using L35040,                                         ~
            ...
            aes_shift$,                  /* Employee shift code        */~
            aes_bdg1$,                   /* Badge 1    CR1437          */~
            aes_bdg2$,                   /* Badge 2    CR1437          */~
            aes_fil$                     /* Filler     CR1437          */

REM         AES_TIME$,                   /* RTIME FOR LABEL PRINT      */~
...
L30017:
            ...
            rec% = 1% : rec$ = "1"
            read #1,key 0% = aes_key$, using L30000, aes_rec$, aes_rec2$,    ~
                       eod goto L30020                      /* CR1437 */
        return
L30020:     rec% = 0% : rec$ = "0"
...
L35040:     FMT CH(30),                  /* Lot Number                 */~
                ...
                CH(02),                  /* Employee Shift             */~
                CH(05),                  /* Badge 1     CR1437         */~
                CH(05),                  /* Badge 2     CR1437         */~
                CH(20)                   /* Filler Area CR1437         */
...
/* CR1437 add badge */
              on fieldnr% gosub L40160,     /* Part Number             */~
                                ...
                                L40160      /* Badge2                  */
            if aes_prt_flg$ <> "A" and aes_prt_flg$ <> "B" and            ~
               aes_prt_flg$ <> "C" then goto L40190
/* CR1437               lfac$(3%) = hex(84)  */
...
L40190:     accept                                                       ~
               ...
               at (05,25), fac(lfac$(2%)), sc_rack_qty$         , ch(10),~
                                                                         ~
               at (06,02), "Shift                :",                     ~
               at (06,25), fac(lfac$(3%)), aes_shift$           , ch(02),~
               at (06,30), fac(hex(84)), aes_shift_desc$        , ch(30),~
                                                                         ~
               at (07,02), "Printer              :",                     ~
               at (07,25), fac(lfac$(4%)), aes_prt_flg$         , ch(01),~
               at (07,27), fac(hex(84)), aes_prt_flgd$          , ch(10),~
                                                                         ~
               at (08,02), "Badge 1              :",                     ~
               at (08,25), fac(lfac$(5%)), aes_bdg1$            , ch(05),~
               at (08,35), "Badge 2  :",                                 ~
               at (08,46), fac(lfac$(6%)), aes_bdg2$            , ch(05),~            
                                                                         ~
               at (09,02), fac(hex(94)), spec_errormsg$         , ch(79),~
                                                                         ~
               at (10,02), "Ln Qty After Label   :",                     ~
               at (10,25), fac(hex(94)), sc_available$          , ch(10),~
                                                                         ~
...
L40400:        if keyhit% <> 8% then goto L40410
                  return clear all
                  goto inputmode_a     /* Delete a Serial Number */
                  
L40410:        if keyhit% <> 9% then goto L40420
                  gosub rolodex
                  goto L40190
...
L40450:        close ws
        ...
        if edit% = 2% then L40610     /*  Input Mode             */
            ...
            pf$(2%) = "                 (8)Delete Ser./Lookup  " &        ~
                      "    (9) Rolodex         (15)Print Screen"
            pf$(3%) = "                                        " &        ~
                      "                       (16)Exit Program"
            pfkeys$ = hex(01ffff04ffffff08090affffffff0f1000)
...
L40610: if fieldnr% > 0% then L40700  /*  Edit Mode - Select Fld */
            pf$(1%) = "(1)Start Over         (14)THERMAL LABELS" &        ~
                      "                                       "
            pf$(2%) = "                                        " &        ~
                      "                      (15)Print Screen "
            pf$(3%) = "                                        " &        ~
...
/* CR1437 */
            ...
            return
                                             /* (VBKMASTR)             */
        Rem Purchase Order Number               sc_po$
...
L50030:     errormsg$ = "(Error) Invalid Purchase Order Number-" & aes_po$
        ...
        Rem P.O. Lime Item Number               sc_item$
            ...
            if lookup_raw_material% = 0% then goto L50060
                                                   /* (AWD004)        */
            if aes_prt_flg$ = "A" or aes_prt_flg$ = "B"       ~
                                  then lfac$(4) = hex(84)
            if aes_prt_flg$ = "C" then lfac$(4) = hex(84)
            aes_prt_flgd$ = "AES  "
            if aes_prt_flg$ = "B" then aes_prt_flgd$ = "AES backup"
            if aes_prt_flg$ = "C" then aes_prt_flgd$ = "TEXAS"
                                                   /* (AWD004)        */
        return
L50055:     errormsg$ = "(Error) Looking Up PO/Line Item-" & aes_po$ & ~
                        aes_item$
            gosub error_prompt
...
L50060:     errormsg$ = "(Error) Looking Up Raw Material-" & aes_part$
        ...
        return
            ...
            aes_key$ = aes_serial$   /* This should not occurr */
            read #1,key = aes_serial$,using L30000, aes_rec$, aes_rec2$,  ~
                     eod goto L50074

            errormsg$ = "(Warning) This is a label reprint!!!"
        ...
        get #1, using L35040,                                            ~
            ...
            aes_rcv_tme$,                /* Time Label Rack Qty Recv   */~
            aes_rcv_usr$,                /* Rack Receiver processed by */~
            aes_shift$,                  /* Employee Shift             */~
            aes_bdg1$,                   /* Badge 1     CR1437         */~
            aes_bdg2$,                   /* Badge 2     CR1437         */~
            aes_fil$                     /* Filler Area CR1437         */
...
L50074:    return
        ...
        rolodex
          call "PROCLINK" ("APCROLEZ","        ","      ",0%,0%)
        return
        
L50075: Rem Part Number
        init(" ") aes_descr$
        gosub lookup_part
        for l% = 1% to max_tm_part%
           if tm_part$(1,l%) = aes_part$ then lookup_raw_material% = 1%
        next l%
...
REM         IF P% = 0% THEN GOTO L50082
            sc_available = 0.0
            aes_qty      = 0.0
            sc_rack_qty  = 0.0
            convert sc_rack_qty$ to sc_rack_qty, data goto L50082
            sc_rack_qty% = sc_rack_qty
            sc_rack_qty  = sc_rack_qty%
/*(AWD009)*/
REM IF SC_RACK_QTY < 10.0 THEN GOTO L50082
            if sc_rack_qty < 8.0 then goto L50082

            if sc_rack_qty > 9999.0 then goto L50085
REM CONVERT SC_RACK_QTY TO SC_RACK_QTY$, PIC(####.####-)
            ...
            if aes_serial$ = " " then gosub assign_serial_no
...
REM CONVERT SC_RACK_QTY TO SC_RACK_QTY$, PIC(####.####-)
            ...
            if spec_errormsg% = 1% then goto L50082
            if spec_errormsg% = 2% then goto L50085
                                                      /* (AWD001)      */
        return

L50082:   errormsg$ = "(Error) Invalid AES Rack Quantity?"
          gosub error_prompt
          init(" ") sc_rack_qty$, aes_qty$, sc_available$
        return                                        /* (AWD001)      */
L50085:   errormsg$ = "(Error) Rack Quantity Exceed's P.O. Available Qty?"
          gosub error_prompt
          init(" ") sc_rack_qty$, aes_qty$, sc_available$
        return

L50090: Rem Shift                               sc_shift$
          init(" ") readkey$, desc$, aes_shift_desc$
          str(readkey$,1%,9%)  = "EMP SHIFT"
          str(readkey$,10%,2%) = aes_shift$
          read #5,key = readkey$, using PO_8, desc$, eod goto L50095
        aes_shift_desc$ = desc$
        return
     
L50095:
        errormsg$ = "(Error) Invalid shift entered.                    "
        return
...
L50100: Rem Printer         aes_prt_flg$
          ...
          if aes_prt_flg$ = "C" then return

        errormsg$ = "(Error) Invalid printer selected {A|B|C}.           "
        return

L50105:  /* CR1437 */
        if aes_bdg1$ = " " then return
           read #14, key = aes_bdg1$, eod goto L50107
        return
        
L50107:  /* CR1437 */
          errormsg$ = "(Error) Invalid Badge Number" 
          gosub error_prompt
        return 
        
L50110:   /* CR1437 */
        if aes_bdg1$ = " " then return
           read #14, key = aes_bdg2$, eod goto L50107
        return
        
        Rem User ID         aes_userid$
          init(" ") readkey$, desc$, aes_user_name$
          code% = 0%
          if aes_userid$ = "XXX" then goto L50115
          init(" ") scr_id_d$
          read #6,key = aes_userid$, using L11750, scr_id_d$,eod goto L50115
L11750:       FMT POS(4), CH(30)
          code% = 1%
          aes_user_name$  = scr_id_d$
        return
L50115:
          errormsg$ = "(Error) Invalid User ID entered.                  "
          gosub error_prompt
        return
...
L52020:
          ...
          read #1,key 0% = sc_serial$, using L52030, aes_rec$, aes_rec2$,   ~
                                                      eod goto L52050
L52030:        FMT CH(254), CH(30)               /* CR1437 */
...
/* CR1437 */
          read #1,hold,key 0% = aes_serial$, using L52030,aes_rec$, aes_rec2$, ~
                        eod goto L53000
             ...
             str(aes_rec$,209%,4%) = "0000"
                                              /* (AWD002) CR1437           */
             write #1, using L52030, aes_rec$, aes_rec2$, eod goto L53010
                                              /* Correct Receiver        */
...
/* CR1437 */
          read #1,hold,key 0% > aes_key$, using L52030, aes_rec$, aes_rec2$,  ~
            ...
            write #1, using L52030, aes_rec$, aes_rec2$, eod goto L53020
...
L53020:   errormsg$ = "(Error) Adjusting Quantity for P.O. Line " & ~
                      str(aes_rec$,1%,19%)
          gosub error_prompt
          return

L53030:   errormsg$ = "(Error) Adjusting Inventory Quantity for P.O. Line "~
                      & str(aes_rec$,1%,19%)
          gosub error_prompt
          return
...
PO_5:
        ...
        lookup_raw_material                  /* (HNYMASTR)         */
          ...
          read #4, key 0% = aes_part$, using PO_6, aes_descr$, tm_uom$, ~
                          part_cat$, part_class$, aes_loc$, part_type$, ~
                          aes_pan, aes_cut_ln$, aes_colour$, eod goto PO_7

PO_6:        FMT POS(26), CH(32), POS(74), CH(04),               ~
...
REM  SC_RACK_QTY$ = AES_PAN$
            convert aes_pan to org_qty$, pic(#####0-) /* AWD008 */
...
REM STR(READKEY$,10%,2%) = STR(AES_PART$,5%,1%)
           str(readkey$,10%,1%) = aes_colour$
...
PO_9:   return
        ...
        lookup_cut_length
           ...
           if p% <> 0% then aes_cut$ = str(aes_descr$,p%-4%, 5%)
PO_10:
           if aes_cut_ln$ > "0000" then aes_cut$ = aes_cut_ln$
        return

        search_labels
/* CR1437 */
           init(" ") aes_key$, aes_rec$, aes_rec_sav$, aes_rec2$, aes_rec2_sav$
...
search_labels_error
        ...
        assign_serial_no
            ...
            if userid$ = "TX1" then str(readkey$,10%,15%) = "200"
            if userid$ = "IVT" then str(readkey$,10%,15%) = "300"
            read #5,hold,key = readkey$, using ASSIGN_1, aes_serial_desc$,~
                                                        eod goto ASSIGN_2
ASSIGN_1:        FMT CH(128)
...
/*   IF LIB$ <> "APCDATA" AND LIB$ <> "APCDATA" THEN GOTO BAD_LIBRARY*/
/* </VOLUME CHECK> */

           tm_prt$ = "          "
           if thermal$ = "0" then goto skip_thermal
            for l% = 1% to max_tm_part%
               if tm_part$(1,l%) = aes_part$ then tm_prt$ = tm_part$(2,l%)
            next l%
           if thermal$ = "1" and tm_prt$ = "         " then goto thermal_err
skip_thermal
           if tm_uom$ = "FT" and str(aes_rec$,143%,8%) <= "0000" then  ~
                      goto uom_err
            put str(aes_rec$,103%,8%), using PO_4, sc_rack_qty
            init(" ") des$
            des$ = str(aes_rec$,143,8)
/* CR1437 */
            call "DSDPLA07" (pan%, been_here%, aes_rec$, aes_rec2$,  ~
                       aes_prt_flg$,    ~
                       err%, aes_shift$, aes_shift_desc$, aes_userid$,    ~
                       tm_prt$, org_qty$, tm_uom$)
...
thermal_err: errormsg$ = "(Error) Invalid Thermal Material Number?"
            gosub error_prompt
            init (" ") sc_raw$, sc_raw_d$
        return

uom_err: errormsg$ = "(Error) Invalid Cut Length Value?"
            gosub error_prompt
            init (" ") sc_raw$, sc_raw_d$
        return
...
REM BAD_LIBRARY
           ...
           msg$(1%) = " CAELUS using wrong library: " & lib$
           msg$(2%) = " LOGOFF and log back in to continue.       "
...
create_rack_label_2
        ...
        search_for_pos_nxt
            ...
            if str(vbline_rec$(),1%,7%) <> "VE32678" then goto       ~
                                                   search_for_pos_done
            ...
            search_for
               init(" ") vdt_due$, vq_ordr$, vq_out$, rhh$
...
DISP_12: return
        ...
        unpack_data
            init(" ") aes_po$, aes_item$, aes_pan_no$, aes_part$,          ~
                      aes_descr$, aes_qty$, aes_scan_dte1$, aes_scan_tme1$,~
                      aes_scan_qty$, aes_scan_usr$, aes_awd_dte1$,         ~
                      aes_awd_tme1$, aes_awd_qty$, aes_awd_usr$,           ~
                      aes_rcv_dte1$, aes_rcv_tme1$, aes_recv$,             ~
