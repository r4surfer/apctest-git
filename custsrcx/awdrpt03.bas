        REM *************************************************************~
            ...
            *               call "AWDCALPR" - Calc Custom Glass/Grid Prc*~
            ...
            * 04/11/05 ! Modes for New Custom Pricing 	          !     *~
            * 01/01/06 ! (PAR000) CR347 Mod for New Sub Part No.  ! RHH *~
            * 05/03/07 ! (AWD001) mods for 18 mm grid             ! CMG *~
            *************************************************************
        ...
        REM *************************************************************~
            ...
            *************************************************************
            ...
            pname$ = "AWDRPT03 - 01/01/2006"               /* (PAR000) */
        ...
        REM *************************************************************~
            ...
            *************************************************************
            ...
            scr_sel$ = "9"          /* Special Selection for (AWDCALPR) */
...
L55210: %!Number!Order DATE!Customer !Sales  Ord! Line!Model!Shape!Grid!G~
        ~lass!Quantity!Custom Price!Total  Price!<----- Description ----->~
        ~!
...
REM 18 mm grid
           if str(sub_part$,1%,1%) = "2" and            ~
                 str(sub_part$,2%,1%) = "4" then sh_type$ = "5"
/* (/AWD001) */
...
/* (AWD001) */
           if sh_type$ = "5" then str(ct_rec$,44%,3%) = "18"
...
/* (AWD001) */
           if sh_type$ = "5" then str(ct_rec$,90%,6%) = ".71000"  /* 18 mm */
