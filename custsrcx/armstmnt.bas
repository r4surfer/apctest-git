        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            ...
            * 11/14/97 ! Revision To 60403 Update                 ! DJD *~
            * 04/03/98 ! Make mods to Latest Version for (EWD)    ! RHH *~
...
L12360:     select printer  (90)
        ...
        REM (EWD) MODS                       /* (EWD) MOD - 05/02/97    */
            init(" ") compaddr$()
            compaddr$(1) = "REMIT TO:                     "
            compaddr$(2) = "       Ellison Windows & Doors"
            compaddr$(3) = "       P.O. BOX 65345         "
            compaddr$(4) = "       CHARLOTTE, N.C. 28265  "
                                             /* (EWD) - End */
        select_loop
...
L17100:     print page
            print skip(4)               /* (EWD) MOD - CHG (3) TO (4)   */
            print using L18040, billto$, asof$, page%
            print skip(1)               /* (EWD) MOD - CHG (2) TO (1)   */
