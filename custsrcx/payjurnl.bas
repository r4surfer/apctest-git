        ...
        REM *************************************************************~
            ...
            * #17 ! GLORTRAN ! GL Oracle transmit file     (AWD001)     *~
            * #18 ! GENCODES ! GENERAL CODES MASTER FILE   (AWD001)     *~
...
/* (AWD001) */
            ...
            if f2%(17) = 0 then L09000
               call "OPENFILE"(#17, "OUTPT", f2%(17), rslt$(17), axd$(17))
               close #17
               call "OPENFILE"(#17, "SHARE", f2%(17), rslt$(17), axd$(17))
...
L09000: REM *************************************************************~
        ...
        REM *************************************************************~
            ...
            *************************************************************
            ...
            call "SCHEMA" (schema$, schema%, #18, schema_err%)
        ...
        def fn'151(account$, debitamnt, creditamnt )
             /* POST TO GLMAIN (TEXT$ FROM PAYJRNTF,EXCEPT ON SUM POST)*/
                call "GLPOST2"(account$, debitamnt, creditamnt, gldate$, ~
                            ...
                            division$, #15, #16, #2, #17,  /* (AWD001) */~
                            0%, invoice$, gl_post_info$())
