        REM *-----------------------------------------------------------*~
            ...
            * AA  AA  W   W DD  D  EE    DD  D   II     11          8   *~
            * AAAAAA  W W W DD  D  EEEE  DD  D   II      1      8888    *~
            * AA  AA  WW WW DD  D  EE    DD  D   II      1          8   *~
            ...
            *---WHEN---+--------------WHAT------------------------+-WHO-*~
            *02/22/2007! Copied from awdedi04 for Eastern Alumin  ! DES *~
            *06/04/2013! (AWD001) mod for schema                  ! CMG *~ 
            *-----------------------------------------------------------*
...
L01450:    str(apcmc_key$,1%,2%)   = type$
           ...
           if edi_id$ <> "047" then goto read_next_inv
