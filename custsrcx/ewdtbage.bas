        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *  EEEEE  W   W  DDDD   TTTTT  BBBB    AAA    GGGG  EEEEE   *~
            *  E      W   W  D   D    T    B   B  A   A  G      E       *~
            *  EEEE   W W W  D   D    T    BBBB   AAAAA  G GGG  EEE     *~
            *  E      WW WW  D   D    T    B   B  A   A  G   G  E       *~
            *  EEEEE  W   W  DDDD     T    BBBB   A   A   GGG   EEEEE   *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * EWDTBAGE - Prints Detail Trial Balance (Driver).          *~
            *-----------------------------------------------------------*~
            ...
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 05/24/01 ! Original - With mods to add addition     ! CMG *~
            *          !            aging bucket                  !     *~
