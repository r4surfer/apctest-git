...
REM             if str(pc_key$,1,4) = "0000" then goto L01050
                if str(pc_key$,7,3) < "210"  then goto L01075
                if str(pc_key$,7,3) > "214"  then goto L01050
                if str(pc_key$,7,3) = "211"  then goto L01100
                if str(pc_key$,7,3) = "212"  then goto L01100

                if str(pc_key$,1,4) <> "0008" then goto L01150
		tmp_rec$(1) = pc_rec$(1)
L01150:
                sv_key$ = pc_key$
                str(sv_key$,7,3) = "211"              
