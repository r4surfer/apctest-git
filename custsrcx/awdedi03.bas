        REM *************************************************************~
            ...
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 10/15/04 ! New Program for (AWD) - Last Mod Date    ! CMG *~
            *************************************************************
        ...
        REM *************************************************************~
            ...
            * #6  ! AWDEDIPL ! EDI Master Control File                  *~
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        dataput
        call "AWDEDI01" (#1,               /* ARIBUFFR File - Headers */ ~
...
L40200:     accept                                                       ~
               at (01,02),                                               ~
                  "AWD EDI Re-Transmit Invoices Plymart",                ~
               at (01,66), "Today:",                                     ~
...
L50120: REM AWD Customer Code                     EDI_CUST$
...
L50300: REM AWD Invoice Number                    EDI_INV$
           init(" ") ar_key$
...
L60330: process_line_done
        ...
        process_header
            ...
            read #1,key = ar_key$, using L60420, terms_disc$, terms_net$, ~
                                       energy$,    eod goto L60490
L60420:        FMT POS(1408), CH(6), POS(1588), CH(6), POS(1819), CH(8)
            edi_seq$ = "  0"
            lh_flag$ = "H"
            ...
            net_due_dt$ = terms_net$
                ...
                get str(energy$,1%,8%) using L60440, energytotal
L60440:                   FMT PD(14,4)
