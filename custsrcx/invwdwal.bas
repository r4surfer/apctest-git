        REM *************************************************************~
            *                                                           *~
            *  IIIII  N   N  V   V  W   W  DDDD   W   W   AAA   L       *~
            *    I    NN  N  V   V  W   W  D   D  W   W  A   A  L       *~
            *    I    N N N  V   V  W   W  D   D  W   W  AAAAA  L       *~
            *    I    N  NN   V V   W W W  D   D  W W W  A   A  L       *~
            *  IIIII  N   N    V     W W   DDDD    W W   A   A  LLLLL   *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * INVWDWAL - Enter Withdrawals from Inventory posting them  *~
            *            to the Withdrawals buffer file for later update*~
            *            to the system Master files (see INVWDWJN).     *~
            *-----------------------------------------------------------*~
        ...
        dim                                                              ~
            ...
            delpart$(900%)45,            /* Deleted part       (PAR000)*/~
            ...
            part$(900%)45,               /* Part number this ln(PAR000)*/~
            ...
            separator$(55)79,            /* Separator lines for tables */~
        ...
        REM *************************************************************~
            ...
            *************************************************************
            dim cms2v$50
            cms2v$ = "REV:01.00 01/30/06 Mod for New Part Number        "
        REM *************************************************************
            mat f2% = con
...
L33120:     convert qty$(currentline%) to qty
                                                 /* (PAR000) No Change */ 
L33140:     call "HNYLCSUB"   (str(part$(currentline%),1%,25%),          ~
                               store$(currentline%),                     ~
                               lot$(currentline%),                       ~
                               qty,                                      ~
                               4%,    /*  WITHDRAWAL MODE              */~
...
L50210:     REM Test data for part number
                ...
                call "PLOWCODE" (#4, plowkey$, infomsg$, -8045%, -.32,   ~
...
L50330:     REM Test data for store
                store$(c%) = " "
                plowkey$ = part$(c%) & store$(c%)
                call "PLOWCODE" (#4, plowkey$, infomsg$,  8045%,  .30,   ~
                                 f1%(4), header$(), 3, 0, incl_excl(),   ~
                                 incl_excl$(), "Y", " ", #6)
                if f1%(4) = 0% then L50420
                   store$(c%) = str(plowkey$,46%)
                   infomsg$ = "(" & infomsg$ & ")"
                if edit% = 0% then return else L50574
...
L50660:            next i%
                                                            /* (PAR000) */
                call "INVAVAIL" (#3, #4, part$(c%), store$(c%), lot$(c%),~
