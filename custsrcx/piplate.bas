        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            ...
            * 01/06/05 ! (AWD001) - Change to add buyer           ! CMG *~
            PRODUCTOFCAELUSASSOCIATESSPOKANEWASHINGTONALLRIGHTSRESERVED**

        dim                                                              ~
            blankdate$8,                 /* Blank Date for Comparison  */~
            buyer$4,                     /* Buyer Code    (AWD001)     */~
...
L19440:     pdate$ = yymmdd$(pipday%)
        ...
        print_it   /* PRINTS THE DETAIL RECORD */
            ...
            print using L19590, part$, partdescr$, pdate$, tag$,          ~
                  round(qty,2%), field$, buyer$           /* (AWD001) */
            field$ = " "
        return
...
L50200:     REM TEST DATA FOR PRINT CHECK START
        ...
        find_buyer                               /* (AWD001) */
            init(" ") buyer$
            buyer$ = "CMG"
            read #3, key = part$, eod goto no_buyer

                 get #3, using L50210, buyer$
L50210:           FMT POS(200), ch(04)
        no_buyer
        return                                   /* (AWD001) */
