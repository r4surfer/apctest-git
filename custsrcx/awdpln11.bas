        ...
        dim                              /* (CATEGORY) - FILE          */~
            readkey$100,                 /* Readkey                    */~
            transaction$16,              /* BNKMASTR first trans num   */~
...
REM             gosub build_file
        ...
        read_mast
            init(" ") readkey$, fields$(), transaction$
            readkey$ = all(hex(00))
            readkey$ = date
            mat num_fields = zer
            rec% = 0%
            read #6, key 1% > readkey$, eod goto read_mast_done
                get #6, using L67120, transaction$
L67120:                 FMT CH(16)
                goto L67100
        read_mast_nxt
            init(" ") fields$()
...
L68110:           FMT CH(16), CH(03), CH(06), CH(06), CH(05), CH(09), CH(16), ~
            ...
            if fields$(3%) < date then goto read_lines_nxt
