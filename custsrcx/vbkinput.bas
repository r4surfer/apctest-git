        ...
        REM *************************************************************~
            ...
            *************************************************************
            ...
            if part$(c%,1%) = " " then return
                ...
                venprice  = round(price    (c%)*factor(c%), 5)
...
L14830:         sumonord$(c%,1%) = qtyonord$
                ...
                if cur_loaded% = 0% then return
                   ...
                   call "CONVERT" (venprice   * cur_factor1, 2.5,        ~
...
L23630:         call "READ100" (#11, str(part$(c%,1%),,25) &             ~
                ...
                if f1%(11) = 0 then L23750
                     ...
                     if testdate$ < effdate$ or                          ~
                        ...
                        venprce = nextprice
                                                     /* (EWD0001) */
L23680:                  FMT POS(69),PD(15,5),POS(89),CH(4),PD(14,4),    ~
...
L53468:     temp = round(temp, 5)
            if abs(temp - venprice) < .000001 then L53512
...
L53524:     temp = round(temp, 7)
            if abs(temp - price(c%)) < .0001 then L53566
