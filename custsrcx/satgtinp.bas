        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            ...
            * CHANGE 1                                                  *~
            * NOTE     - APC MODIFICATIONS FOR 35 PRICE CODES           *~
            *                                                           *~
            *-----------------------------------------------------------*~
	    ...
	    *          !				  	  !	*~
	    * 11/20/97 ! APC MODS ALSO 60403 UPDATES              ! DJD *~
	    *          ! CHANGE 2                                 !     *~
            * 07/05/90 ! APC MOD FOR 35 PRICE CODES               ! RHH *~
            *          !                                          ! RHH *~
        ...
        dim                                                              ~
            ...
            pf16$16,                     /* PF16 Literal               */~
				         /* CHANGE 3                   */~
            pcode$(36)2,                 /* Price code ID - APC MOD    */~
            price$(36)10,                /* Price code    - APC MOD    */~
            price(36),                   /* Price code    - APC MOD    */~
				         /* END CHANGE 3               */~
        ...
        REM *************************************************************~
            ...
            *************************************************************
            dim cms2v$50
            cms2v$ = "R6.04.03 11/20/97 Cycle Counting & MPS Phase I    "
        REM *************************************************************
	    ...
	    /* CHANGE 4 - FIX ARRAY POINTER TO BE 9 WAS 8   */
...
*        Now get selling prices if part involved
            ...
            if f1%(9) = 0% then L11000
		     ...
		     /* CHANGE 5 - CHANGED FROM 16 PD-14 TO 36 PD-14  */
L10540:              FMT XX(56), 36*PD(14,4)
            init(hex(9c)) pfac$()
            for i% = 1% to 13%
