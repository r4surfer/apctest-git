        REM *************************************************************~
            *                                                           *~
            *  IIIII  N   N  V   V   AAA   DDDD   DDDD   N   N   SSS    *~
            *    I    NN  N  V   V  A   A  D   D  D   D  NN  N  S       *~
            *    I    N N N  V   V  AAAAA  D   D  D   D  N N N   SSS    *~
            *    I    N  NN   V V   A   A  D   D  D   D  N  NN      S   *~
            *  IIIII  N   N    V    A   A  DDDD   DDDD   N   N   SSS    *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * INVADDNS - Enter additions to inventory and write to the  *~
            *            additions buffer.                              *~
            *-----------------------------------------------------------*~
	    ...
	    blank_date$8,                /* Blank date check           */~
            ...
            part$(900%)45, partdescr$34, /* PART NUMBER        (PAR000)*/~
        ...
        REM *************************************************************~
            ...
            * #4  ! INVQUAN  ! Inventory store quantity file    (PAR000)*~
            * #5  ! INVADDTF ! Additions buffer for inventory   (PAR000)*~
...
L20480:     REM DEFAULT/ENABLE FOR SOURCE ACCOUNT
                ...
                if srcacct$(c%) = " " then goto L20500 else goto L20540
                                                  /* (PAR000)         */
L20500:         get #3 using L20501, temp$        /* INVMASTR Part Type */
L20501:             FMT POS(200), CH(3)
...
L20505:         src% = 1%                       /* Set for Purchased  */
                ...
                if temp% > 499% then src% = 2%  /* WIP                */
                                                  /* (PAR000)         */ 
                   call "INVGLGET" (part$(c%), store$(c%), lot$(c%),     ~
                                    srcacct$(c%), src%, #3, #4)
...
L30100:     REM GET LINE ITEMS FROM FILE QUICKLY.
                ...
                old% = 1%
                REM GET DATA FROM THE FILE.                  /* (PAR000) */
...
L30460: FMT                 /* FILE: ADDBUFFR                          */~
            ...
            XX(40)          /* Filler (Internal, unused space)(PAR000) */~
...
L31680: FMT                 /* FILE: ADDBUFFR                          */~
            ...
            CH(32),         /* description of purpose                  */~
            CH(16),         /* Purchase Order Number                   */~
            CH(40)          /* Filler(Internal,unused space)   (PAR000)*/
...
L33080:     convert qty$(currentline%) to qty
                                                /* (PAR000) No Change  */
                                                /* Could Be Problem    */
L33100:     call "HNYLCSUB"  (str(part$(currentline%),1%,25%),           ~
                              store$(currentline%),                      ~
                              lot$(currentline%),                        ~
                              qty,                                       ~
                              3%,  /*  Additions Mode                  */~
...
L40530:     REM CALL 'HNYCDIST' FOR INPUT/EDIT OF TOTAL COST FIELD
                ...
                call "HNYCDIST" (mode$, part$(c%), partdescr$,           ~
                     "INVADDNS: Inventory Additions: Cost Distribution", ~
...
L40610:     accept                                                       ~
               ...
               at (22,06), "P/N"                                        ,~
                                                                         ~
               at (06,10), fac(fac$(1, 1)), str(part$(line%+1%), 1%,25%),ch(25),~
               at (06,36), fac(fac$(1, 1)), str(part$(line%+1%),26%,20%),ch(20),~
                                                                         ~
               at (10,10), fac(fac$(2, 1)), str(part$(line%+2%), 1%,25%),ch(25),~
               at (10,36), fac(fac$(2, 1)), str(part$(line%+2%),26%,20%),ch(20),~
                                                                         ~
               at (14,10), fac(fac$(3, 1)), str(part$(line%+3%), 1%,25%),ch(25),~
               at (14,36), fac(fac$(3, 1)), str(part$(line%+3%),26%,20%),ch(20),~
                                                                         ~
               at (18,10), fac(fac$(4, 1)), str(part$(line%+4%), 1%,25%),ch(25),~
               at (18,36), fac(fac$(4, 1)), str(part$(line%+4%),26%,20%),ch(20),~
                                                                         ~
               at (22,10), fac(fac$(5, 1)), str(part$(line%+5%), 1%,25%),ch(25),~
               at (22,36), fac(fac$(5, 1)), str(part$(line%+5%),26%,20%),ch(20),~
                                                                         ~
                                                                         ~
               at (06,57), "Str"                                        ,~
               at (10,57), "Str"                                        ,~
               ...
               at (22,57), "Str"                                        ,~
                                                                         ~
               at (06,61), fac(fac$(1, 2)), store$   (line%+ 1) , ch( 3),~
               at (10,61), fac(fac$(2, 2)), store$   (line%+ 2) , ch( 3),~
               at (14,61), fac(fac$(3, 2)), store$   (line%+ 3) , ch( 3),~
               at (18,61), fac(fac$(4, 2)), store$   (line%+ 4) , ch( 3),~
               at (22,61), fac(fac$(5, 2)), store$   (line%+ 5) , ch( 3),~
                                                                         ~
               at (06,65), "Qty"                                        ,~
               at (10,65), "Qty"                                        ,~
               at (14,65), "Qty"                                        ,~
               ...
               at (22,65), "Qty"                                        ,~
                                                                         ~
               at (06,69), fac(fac$(1, 4)), qty$     (line%+ 1) , ch(10),~
               at (10,69), fac(fac$(2, 4)), qty$     (line%+ 2) , ch(10),~
               at (14,69), fac(fac$(3, 4)), qty$     (line%+ 3) , ch(10),~
               at (18,69), fac(fac$(4, 4)), qty$     (line%+ 4) , ch(10),~
               at (22,69), fac(fac$(5, 4)), qty$     (line%+ 5) , ch(10),~
                                                                         ~
               at (07,02), "Cost Each "                                 ,~
               at (11,02), "Cost Each "                                 ,~
               at (15,02), "Cost Each "                                 ,~
...
*        Test data for STORE
            ...
            if f1%(6%) = 1% then L50320
                ...
                return
                                                         /* (PAR000)    */
L50320:     readkey$ = str(part$(c%),,45) & str(store$(c%),,3%)
            init(hex(00))str(readkey$, 49%)               /* (PAR000)    */
            call "PLOWNEXT" (#4, readkey$, 48%, f1%(4%))
            if f1%(4%) = 1% then L50370
                infomsg$ = "No Quantity Record.  One will be created."
L50370:     if edit% = 1% then return
                                                         /* (PAR000)    */
L50381
*        Test LOT NUMBER                          /* (PAR000) No Change */
...
L51150:             FMT XX(44), CH(6)
        ...
        enter_serial_numbers                      /* (PAR000) No Change */
