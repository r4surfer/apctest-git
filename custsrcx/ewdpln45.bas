        REM *************************************************************~
            *  Program Name      - EWDPLN45      (clone from EWDPLN42)  *~
            *  Creation Date     - 11/24/2008                           *~
            *                                                           *~
            *  Description       - Stock Production Labels Printing.    *~
            ...
            *                                                           *~
            *  Subroutine Used   - EWDPLS45 (Print Stock Production Lbl)*~
            *                      Changed for new Sub Part Number      *~
            *                                                           *~
            *  Special Comments  - CR2658                               *~
            *                                                           *~
            *-----------------------------------------------------------*~
        ...
        dim                                                              ~
            ...
            sc_seq_fr$5,                 /* Beginning Sequence         */~
            sc_seq_to$5,                 /* Ending Barcode             */~ 
        ...
        REM *************************************************************~
            ...
            *************************************************************
            dim apc$40, pname$21                            /* (AWD023) */
                                                            ...
                                                            /* (PAR003) */
                                                            /* (PAR004) */
            apc$   = "Generate Stock Labels- 08-12-2020"
            pname$ = "EWDPLN45 - Rev: R1.00"
...
*/
            ...
            if err% <> 0% then gosub open_error
            filename$ = "APCPCMST" : call "EWDOPEN" (#8, filename$, err%)
            if err% <> 0% then gosub open_error
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        initialize_variables
            init(" ") errormsg$, inpmessage$, sc_dept$, sc_dept_d$,      ~
                      ...
                      sc_end_prddate$, sc_sel$, sc_seq_fr$, sc_seq_to$
        ...
        dataload                                         /* (EWD001)   */
            call "SHOSTAT" ("Printing Stock Production Labels...")
...
REM     @@@@@@@@ add sc_sel$ so it can filter by label type..... 
            call "EWDPLS45" (been_here%, lb_rec$(), #4, #1, #6, #63, #7, ~
                 #8, sc_sel$, lbl%, err%)
...
L40190:     accept                                                       ~
               ...
               at (05,25), fac(lfac$(3%)), sc_load_fr$          , ch(05),~
               at (05,45), fac(lfac$(3%)), sc_load_to$          , ch(05),~
                                                                         ~
               at (06,02), "Barcode No. Range:",                         ~
               at (06,25), fac(lfac$(4%)), sc_barcode_fr$       , ch(18),~
...
L50300:
            ...
            if sc_sel$ < "01" or sc_sel$ > "01" then goto L50350
        return

L50350:    errormsg$ = "(Error) Invalid Label Type (1)"
           gosub error_prompt
           sc_sel$ = "01"
        return
