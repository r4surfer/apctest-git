...
L40190:     accept                                                       ~
               ...
               at (07,45), fac(lfac$(5%)), sc_barcode_to$       , ch(18),~
                                                                         ~
               at (08,02), "Label Type       :",                         ~
               at (08,25), fac(lfac$(6%)), sc_sel$              , ch(01),~
                                                                         ~
               at (10,02), "                  1 = 150 SH  ",             ~
               at (11,02), "                  2 = 150 SH  w/grid",       ~
               at (12,02), "                  3 = 151 Slider",           ~
               at (13,02), "                  4 = 450 DH  ",             ~
               at (14,02), "                  5 = 450 DH  w/grid",       ~
               at (15,02), "                  6 = 3100 SH",              ~
               at (16,02), "                  7 = 3100 SH w/grid",       ~
...
L50250:     errormsg$ = "(Error) Invalid Barcode, Can Only Print Single Label?"
        ...
        return 
                                                    /* (AWD026)          */
L50300:
            if sc_sel$ < "1" or sc_sel$ > "7" then goto L50350
        return 

L50350:    errormsg$ = "(Error) Invalid Label Type (1-7)"
           gosub error_prompt
           init(" ") sc_sel$
        return
