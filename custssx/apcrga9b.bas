        REM *************************************************************~
            ...
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 11/21/95 ! New Program for (APC) - Last Mod Date    ! JBF *~
        ...
        sub "APCRGA9B"  (#1,             /* GENCODES File Channel      */~
...
L61440:
            ...
            read #8,key = bck_key$, using L61490, bck_text$,              ~
                eod goto L61510
L61490:         FMT POS(242), CH(04)
