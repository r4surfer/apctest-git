REM         *-----------------------------------------------------------*~
            * EWDLOGUP - Updates current EWDXOLOG rec with program name.*~
            *-----------------------------------------------------------*~
            *                  M O D I F I C A T I O N S                *~
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 04/05/99 ! ORIGINAL - Copied & Mod Sub EWDLOGOU.    ! BWS *~
            *************************************************************

        sub "EWDLOGUP" (prog$)           /* '?'=Current Pgm, ' '=Done  */
                                         /* or Pass-In Value.          */
        dim                                                              ~
            file$8,                      /* File Name                  */~
        ...
        REM *************************************************************
            ...
            if prog$ = "?" then call "EXTRACT" addr("CF", prog$)
...
L00500:         fmt pos(39), ch(6), pos(402), ch(6)
            ...
            put #2, using L00600, prog$
L00600:         fmt pos(16), ch(8)
            rewrite #2, data goto L65000
