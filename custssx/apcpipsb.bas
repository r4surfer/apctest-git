        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *  Called By (ARIUPDTE), (BCKUPDTE), (APCINVBO), (SHPACTIN) *~
            *                                                           *~
            ...
            * 12/27/97 ! Special Mod for (EWD), Allow no pipouts  ! RHH *~
            *          ! Change Sub Call, Rem entries to write    !     *~
            *          ! PIP'S at comment Do PIPOUT First. All    !     *~
            *          ! Mods Marked by  (EWD)                    !     *~
            * 03/31/98 ! Mods for (Y2K)                           ! RHH *~ 
            PRODUCTOFCAELUSASSOCIATESSPOKANEWASHINGTONALLRIGHTSRESERVED**
                                                /* (EWD) - Change Call */
        sub "APCPIPSB" (so$,             /* Sales Order Number         */~
...
* (EWD)       write #7 using L12820, so$, seq$, part$, reqdship%,           ~
* (EWD)                                                    time, pipoutqty
* (EWD) L12820:  FMT CH(16), CH(3), CH(25), BI(4), CH(8), PD(14,4)
* (EWD)     call "PIPFLAGS" (part$, 1%, reqdship%, -pipoutqty, #5, #12)
