        REM *************************************************************~
            *                                                           *~
            *   AAA   PPPP    CCC   PPPP    OOO    SSSS  TTTTT          *~
            *  A   A  P   P  C   C  P   P  O   O  S        T            *~
            *  AAAAA  PPPP   C      PPPP   O   O   SSS     T            *~
            *  A   A  P      C   C  P      O   O      S    T            *~
            *  A   A  P       CCC   P       OOO   SSSS     T            *~
            *                                                           *~
            *-----------------------------------------------------------*~
            *            ( Subroutine Version of HNYADDJN )             *~
            * APCPOST  - Journal program for Inventory Additions. Prints*~
