	    ...
	    * 02/26/98 ! CHECKED FOR Y2K COMPLIANCE               ! DJD *~
        ...
        sub "APCRGA6B"  (#1,             /* GENCODES File Channel      */~
...
L19800:     pageno% = 0%
        ...
        initialize_variables
            init(" ") rga_number$, rga_item$, rga_cuscode$, rga_auth_id$,~
                ...
                salesman_name$, rga_salesman$, xtime$, bck_text$
...
L61350:
            ...
            read #8,key = bck_key$, using L61400, bck_text$,              ~
                eod goto L61420
L61400:         FMT POS(242), CH(04)
