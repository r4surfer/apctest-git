        REM CAELUSASSOCIATESSPOKANEWASHINGTONALLRIGHTSRESERVEDCAELUSASSOC~
            *-----------------------------------------------------------*~
            * INVMVMF  - USER CONTROL OF WHAT IS RECORDED AS INVENTORY  *~
...
/* PAR000*/ subp$20,                     /* Subpart Number             */~
        ...
        REM *************************************************************~
            ...
            *************************************************************
            ...
            dim cms2v$50
REM         cms2v$ = "R7.00.00 02/03/06 Year 2000 Compliancy            "
...
*                   1 2 3 4 5 6 7 8 9 A B C D E F1011
            ...
            on type% goto hny_addition,   /* IA = Inventory Addition   */~
                          ...
                          hny_withdraw,   /* IP = Physical adjustment  */~
                          hny_withdraw,   /* IW = Inventory Withdrawal */~
...
noconv
	    put fsclyr$ using fsclyr_fmt, u3%
            readkey$ = str(part$,,25) & str(subp$,,20) & str(store$,,3) & fsclyr$
fsclyr_fmt: FMT BI(4)
...
L11090:     call "READ101" (#2, readkey$, f1%(2))
            ...
            write #2, using L11150, part$, subp$, store$, fsclyr$, zero$,  ~
                                   zero1$, month$(), " "     /* PAR000 */
L11150:     FMT CH(25), CH(20), CH(3), CH(4), CH(208), CH(208), 20*CH(1), CH(32)
            goto L11090

L11180:     get #2, using L11190, zero$, zero1$, month$()
L11190:         FMT POS(53), CH(208), CH(208), 20*CH(1)         /* PAR000 */
