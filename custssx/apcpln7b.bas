        REM *************************************************************~
            *                                                           *~
            *  Program Name      - APCPLN7B - Program (APCPLN04)        *~
            *  Creation Date     - 05/01/96                             *~
            *  Last Modified Date- 12/28/01                             *~
            ...
            *                                                           *~
            *  Subroutine Used   - APCPLN0B - Calc and Edit Production  *~
            *                                 Year, Week, and Day       *~
            ...
            *          !            to improve HP speed.          !     *~
            * 11/09/99 ! (EWD006) - Mod to Close Files when exiting!RHH *~
            *          !            subroutine.                   !     *~
            * 12/28/01 ! (EWD007) - Mod for date for 2002.        ! CMG *~
            ...
            * 04/09/19 ! (CR1979) - New Load Types G & L          ! DES *~
            *************************************************************

         sub "APCPLN7B"  (opn%,          /* Value = 1% Skip Open       */~
                          ld_load$,      /* Load Number Build/Change   */~
                          err% )         /* 0 = OK, 1 = ERROR          */
...
L11150:     fieldnr% = cursor%(1%) - 4%
            if fieldnr% < 1% or fieldnr% > 10% then editpg1   /*  (EWD009)  */
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        scrn1_msg  :  data                                               ~
         "Enter a Valid Load Number or ' '=Reg,'A'=Forecast.'S'=Stock? ",~
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        initialize_variables
            init(" ") errormsg$, inpmessage$, readkey$, desc$,ld_region$,~
                      ...
                      fix_dte1$, ld_app_dte$, ap_ear_tme$, ap_start_dte$,~
                      ap_start_tme$, ap_end_dte$,  ap_end_tme$, ap_truck$,~
                      ap_flag$, ap_up_dte$, ap_type$, ap_desc$, ap_filler$,~
...
L31210:     call "DATUFMTC" (ld_wk_dte$)                                        /* (Y2K, LDJ) */
            ...
            convert ld_year$ to ld_year%, data goto L31220

L31220:     ld_yr$ = bin(ld_year%,2)                                            /* (Y2K, LDJ) */
            ld_status$ = "02"
...
L40260:     accept                                                       ~
               ...
               at (08,30), fac(hex(84)), ld_wk_dte$             , ch(10),       /* (Y2K, LDJ) */~
                                                                         ~
               at (09,02), "Load Region Code:",                          ~
               at (09,20), fac(lfac$(5%)), ld_region$           , ch(02),~
               at (09,30), fac(hex(84)), ld_region_d$           , ch(30),~
                                                                         ~
               at (10,02), "Production Date (Scheduled):",               ~
               at (10,35), fac(lfac$(6%)), ld_dts1$             , ch(10),       /* (Y2K, LDJ) */~
               at (10,50), "(Planned):",                                 ~
               at (10,65), fac(hex(84)),   ld_dtp1$             , ch(10),       /* (Y2K, LDJ) */~
                                                                         ~
               at (11,02), "Completion Date (Scheduled):",               ~
               at (11,35), fac(lfac$(7%)), ld_dts2$             , ch(10),       /* (Y2K, LDJ) */~
               at (11,50), "(Planned):",                                 ~
               at (11,65), fac(hex(84)),   ld_dtp2$             , ch(10),       /* (Y2K, LDJ) */~
                                                                         ~
               at (12,02), "Load Date       (Scheduled):",               ~
               at (12,35), fac(lfac$(8%)), ld_dts3$             , ch(10),       /* (Y2K, LDJ) */~
               at (12,50), "(Planned):",                                 ~
               at (12,65), fac(hex(84)),   ld_dtp3$             , ch(10),       /* (Y2K, LDJ) */~
                                                                         ~
/*EWD009*/     at (13,02), "Earliest Dispatch Date     :",               ~
/*EWD009*/     at (13,35), fac(lfac$(9%)), ld_app_dte$          , ch(10),~
                                                                         ~
/*EWD009*/     at (14,02), "Earliest Dispatch Time     :",               ~
/*EWD009*/     at (14,35), fac(lfac$(10%)), ap_ear_tme$         , ch(04),~
                                                                         ~
               at (16,02), "Load Dollar Val:",                           ~
               at (16,20), fac(hex(84)),   tot_value$           , ch(12),~
               at (16,40), "Load Tot Units :",                           ~
               at (16,60), fac(hex(84)),   tot_units$           , ch(12),~
               at (17,02), "Load Tot Pull  :",                           ~
               at (17,27), fac(hex(84)),   tot_pull$            , ch(05),~
               at (17,40), "Load Tot Make  :",                           ~
               at (17,67), fac(hex(84)),   tot_make$            , ch(05),~
               at (18,02), "Load Tot Product",                           ~
               at (18,27), fac(hex(84)),   tot_product$         , ch(05),~
               at (18,40), "Load Tot Drops :",                           ~
               at (18,69), fac(hex(84)),   tot_drops$           , ch(03),~
                                                                         ~
...
L42190:     accept                                                       ~
               ...
               at (08,30), fac(hex(84)), ld_wk_dte$             , ch(10),       /* (Y2K, LDJ) */~
                                                                         ~
               at (09,02), "Load Region Code:",                          ~
               at (09,20), fac(hex(84)),   ld_region$           , ch(02),~
               at (09,30), fac(hex(84)), ld_region_d$           , ch(30),~
                                                                         ~
               at (10,02), "Production Date (Scheduled):",               ~
               at (10,35), fac(hex(84)),   ld_dts1$             , ch(10),       /* (Y2K, LDJ) */~
               at (10,50), "(Planned):",                                 ~
               at (10,65), fac(hex(84)),   ld_dtp1$             , ch(10),       /* (Y2K, LDJ) */~
                                                                         ~
               at (11,02), "Completion Date (Scheduled):",               ~
               at (11,35), fac(hex(84)),   ld_dts2$             , ch(10),       /* (Y2K, LDJ) */~
               at (11,50), "(Planned):",                                 ~
               at (11,65), fac(hex(84)),   ld_dtp2$             , ch(10),       /* (Y2K, LDJ) */~
                                                                         ~
               at (12,02), "Load Date       (Scheduled):",               ~
               at (12,35), fac(hex(84)),   ld_dts3$             , ch(10),       /* (Y2K, LDJ) */~
               at (12,50), "(Planned):",                                 ~
               at (12,65), fac(hex(84)),   ld_dtp3$             , ch(10),       /* (Y2K, LDJ) */~
                                                                         ~
               at (14,02), "Stock Part No.  :",                          ~
/*PAR000*/     at (14,20), fac(lfac$(1%)), str(stk_part$, 1%,25%), ch(25),~
/*PAR000*/     at (14,47), fac(lfac$(1%)), str(stk_part$,26%,20%), ch(20),~
/*PAR000*/     at (15,27), fac(hex(84)), stk_desc$              , ch(30),~
                                                                         ~
               at (15,02), "Stock Quantity  :",                          ~
               at (15,20), fac(lfac$(2%)), stk_qty$             , ch(04),~
                                                                         ~
               at (21,02), fac(hex(a4)),   inpmessage$          , ch(79),~
               at (22,02), fac(hex(8c)),   pf$(1%)              , ch(79),~
               at (23,02), fac(hex(8c)),   pf$(2%)              , ch(79),~
...
L50180: REM Scheduled Production load             LD_LOAD$
            ...
            if len(ld_load$) = 5 then goto L50260
               ...
               if str(ld_load$,1%,1%) = "G" then assign% = 5% /* CR1979 */
               if str(ld_load$,1%,1%) = "L" then assign% = 6% /* CR1979 */
               return
...
L50480: REM Scheduled Production Week             LD_WK$
           ...
           call "NUMTEST" (ld_year$,1998,2019,errormsg$,0,ld_year)              /* (Y2K, LDJ) */
...
L51800: REM Verify Appian Load Date               LD_APP_DTE$    
           init(" ") x1$, x2$
