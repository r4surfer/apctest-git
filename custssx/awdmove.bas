        REM CAELUSASSOCIATESSPOKANEWASHINGTONALLRIGHTSRESERVEDCAELUSASSOC~
            *                                                           *~
            *   AAA   W   W  DDDD   M   M   OOO   V   V  EEEEE          *~
            *  A   A  WN  W  D   D  MM MM  O   O  V   V  E              *~
            *  AAAAA  W W W  D   D  M M M  O   O  V   V  EEEE           *~
            *  A   A  WW WW  D   D  M   M  O   O   V V   E              *~
            *  A   A  W   W  DDDD   M   M   OOO     V    EEEEE          *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * AWDMOVE  - ALLOWS DIRECT MOVEMENT OF INVENTORY FROM ONE   *~
        ...
        sub "AWDMOVE" (part$, mq$, fstore$, tstore$, serialnumber$,      ~
                       userid$, err%,                                    ~
                         #1,                    /* SYSFILE2           */ ~
                         #2,                    /* STORENAME          */ ~
                         #3,                    /* USERINFO           */ ~
        ...
        dim date$8, hnydate$6, hnydte$8, hnydatef$8, runtime$8, company$30,~
            ...
            passedin_dbcr(50,2), passedin_type$(50)2, serialnumber$8
...
REM            call "EXTRACT" addr ("ID", userid$)
            if sysdates% = 0% then goto L09300
...
*       ********   TOP OF LOOP   ***************************************
        ...
        init (" ")  errormsg$, descr$, newacct$, oldacct$,        ~
                    store$(), lot$(), q$(),  flot$,      ~
                    tlot$, readkey$, plowkey$, mm$,  uom$, uom_descr$
...
*        Load Part Info
            ...
            if f1%(4) = 1% then L10350
                 errormsg$ = "Part not on file"  : goto exit_program
                 goto L10070
...
L12030: call "HNYAVAIL" (#4, #7, part$, fstore$, flot$, errormsg$, mq,   ~
        ...
        goto L12170                         /* Always allow negative */
...
L12370:     REM   mm$ = "MOVED TO STORE" & tstore$ & " LOT" & tlot$
            mm$ = "MOVED SERIAL NO:" & serialnumber$ & " TO STORE:" & tstore$
            ...
            call "HNYPST2" (part$, fstore$, flot$, -mq, 0,0,0,0, cost(), ~
                            ...
                            #20, #50, 1%, returncode%)
REM            mm$ = "MOVED FROM STR" & fstore$ & " LOT" & flot$
            mm$ = "MOVED SERIAL NO:" & serialnumber$ & " FROM STORE:" & fstore$
            this% = 0%
            gltext$ = "TO STR: " & str(tstore$) & " LOT: " & str(tlot$)
            str(gltext$,31) = str(part$) & str(fstore$) & str(flot$)
            str(gltext$,69,32) = "TRANSFER"
...
L14300:            FMT CH(5), POS(18), 2*PD(15,4), POS(164), CH(3)
        ...
        post_gl
            ...
            call "GLPOST2" (acct$(1),    /* ACCOUNT TO BE UPDATED      */~
                      ...
                      userid$,           /* WHO                        */~
                      division$,         /* Division Number (AWD001)   */~
