        REM *************************************************************~
            *                                                           *~
            *  IIIII  N   N  V   V  M     M   SSSS  TTTTT   SSSS  BBBB  *~
            *    I    NN  N  V   V  MM   MM  S        T    S      B   B *~
            *    I    N N N  V   V  M M M M   SSS     T     SSS   BBBB  *~
            *    I    N  NN   V V   M  M  M      S    T        S  B   B *~
            *  IIIII  N   N    V    M     M  SSSS     T    SSSS   BBBB  *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * INVMSTSB - Display INVMASTR data.                         *~
            *-----------------------------------------------------------*~
            ...
            *----------+------------------------------------------+-----*~
            * 03/03/06 ! (PAR000) CR347 Mods for new Part Number  ! RHH *~
            *************************************************************

        sub "INVMSTSB" (part_key$,                                       ~
               #1, /* SYSFILE2 ! System Default Information File      */ ~
               #2, /* INVMASTR ! Inventory Master File        (PAR000)*/ ~
              ...
              #17, /* INVQUAN  ! Inventory Quantities File    (PAR000)*/ ~
        ...
        dim                                                              ~
            ...
            sub_part$20,                 /* New Sub Part       (PAR000)*/~
            part_key$45,                 /* New Part Number            */~  
...
L31020:     FMT XX(45),          /* Part Number                (PAR000)*/~
                CH(32),          /* Description                        */~
...
L40230:     accept                                                       ~
               ...
               at (05,57), fac(hex(84)) , sub_part$             , ch(20),~
