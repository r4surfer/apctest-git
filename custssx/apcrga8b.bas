        REM *************************************************************~
            ...
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 11/17/95 ! New Program for (APC) - Last Mod Date    ! JBF *~
	    ...
	    * 02/26/98 ! checked for y2k compliance               ! DJD *~
        ...
        sub "APCRGA8B"  (#1,             /* GENCODES File Channel      */~
...
L61510:
            ...
            read #8,key = bck_key$, using L61560, bck_text$,              ~
                eod goto L61580
L61560:         FMT POS(242), CH(04)
