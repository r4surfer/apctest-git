        REM *************************************************************~
            *                                                           *~
            * AAAAAA  W   W DDDD   IIII  BBBBB   SSSS  00000  4   4     *~
            * AA  AA  W   W DD  D   II   B    B  S     0   0  4   4     *~
            * AAAAAA  W W W DD  D   II   BBBBB    S    0   0  44444     *~
            * AA  AA  WW WW DD  D   II   B    B    S   0   0      4     *~
            * AA  AA  W   W DDDD   IIII  BBBBB  SSSS   00000      4     *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * AWDIBS04 - Subroutine To Create Invoice Edi Transmit File *~
            *            to send to IBSA                                *~
            ...
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 11/14/05 ! Original                                 ! TBM *~
            *04/16/2010! (AWD001) mod to lookup branch number     ! CMG *~
            *-----------------------------------------------------------*

        sub "AWDIBS04" (#1,                /* ARIBUFFR File - Headers */ ~
        ...
        dim usr_cust_code$10,            /* (AWD001) branch number     */~
            key_data$90                  /* (AWD001) data sent edimail */
...
L03000:       put #6,using  L03210, "S",       /* STATUS CODE (S/T/R)    */~
                                  ...
                                  usr_cust_code$, /*(AWD001) branch num*/~
                                  " ",        /* Filler Spaces         */~
                                  tr_dte$,    /* Create Date           */~
                                  " ",        /* Filler Spaces         */~
                                  edi_cust1$   /* Customer Number EWD006*/
...
L03400:       goto L03470      /* Make IBSA Sku Number AWD Part Number */
...
/* (AWD001) */
        set_user_cust_code
           ...
           read #4,key = readkey$, using L04650, desc$, eod goto noBranch
           
                usr_cust_code$ = str(desc$,1,10)
        return

noBranch: init(" ") key_data$
          ...
          str(key_data$,66,09) = edi_cust$  
	      str(key_data$,75,01) = hex(22)     
          call "MAILSUB" (key_data$)                                
	      usr_cust_code$ = str(edi_cust$,3,4)
        return
/* (AWD001\) */                      
        exit_program
         end
