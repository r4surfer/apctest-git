...
*                  (PAR000)  01/15/06 CR347          Dept (051)        *~
...
*                                                                      *~
*                                                                      *~                                  
*                  New Flex Line Processing for 500 Continuous Head    *~
*                  ( As of 01/15/2006 - RHH  Dept 051 )                *~
*                                                                      *~
*        AWDPLE42 - Create File with Data for Saw Optimization         *~
*                   with Weld information also.                        *~
*                                                                      *~
*         Subs Replaced - EWDPLD42 (L), EWDPLE42 (W-F)                 *~
*                                       EWDPLF42 (W-S)                 *~ 
*                                                                      *~
*        (EWD032)                                                      *~                                          
*            File Layout                                               *~
...
************************************************************************
        ...
        sub "AWDPLE42" (size%,           /* Batch Size (No. Windows)  */ ~
...
L02620:   errormsg$ = saw_err$(type%)
        ...
        build_detail_weld                         /* j% = 1%   (Frame) */
          ...
          if j% = 2% and model$ = "450" then                             ~
             str(bat_rec$,16%,4%) = "0002"              /* Change Qty  */

          if j% = 2% and model$ = "470" then                             ~
             str(bat_rec$,16%,4%) = "0002"              /* Change Qty  */

          if j% = 2% and model$ = "460" then                             ~
             str(bat_rec$,16%,4%) = "0003"              /* Change Qty  */

          if j% = 2% and model$ = "480" then                             ~
             str(bat_rec$,16%,4%) = "0003"              /* Change Qty  */
