...
*             (PAR000) 01/15/06 CR347               Dept (027)         *~
...
*                                                                      *~
*        AWDPLF42 - Create File with Data for Saw Optimization         *~
...
*           12/01/2015!(SR70993) mod to add F for foam to raw mat! MES *~
...
************************************************************************
        ...
        sub "AWDPLF42" (size%,           /* Batch Size (No. Windows)  */ ~
