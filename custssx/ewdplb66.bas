        REM *************************************************************~
            *                                                           *~
            *  Program Name      - EWDPLB66 - Program (EWDPLN66)        *~
            *  Creation Date     - 02/01/99 - File - (@BILSPC@)         *~
            *  Last Modified Date- 03/19/06                             *~
            *  Written By        - Royal H. Hoffman                     *~
            *                                                           *~
            *  Description       - Create BILCO Glass Bridge File for   *~
            ...
            *      - Bridge File Names                                  *~
            *        (@BILSPC@) - Special glass created by Planning     *~
            *        (@BILSP1@) - Special glass created by Other        *~
            *                                                           *~  
            *-----------------------------------------------------------*~
            *                  M O D I F I C A T I O N S                *~
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 09/15/99 ! New Program for (APC) - Last Mod Date    ! RHH *~
            * 05/23/05 ! (AWD001) Mod to add 3/4" grid            ! CMG *~
            * 01/01/06 ! (PAR000) CR347 Mod for new Sub Part No.  ! RHH *~
            * 03/19/06 ! (AWD002) mod for krypton glass           ! CMG *~       
            *************************************************************

        sub "EWDPLB66" (size%,           /* Specified Batch Size      */ ~
                        glass_dte$,      /* Glass Production Date     */ ~
                        file$,           /* Name of Optimized File 0  */ ~
                        bat$,            /* Number of Batches Created */ ~
                        sp_created$,     /* Created By                */ ~
                        #1,              /* (GENCODES) Master Tables  */ ~
                        #2,              /* (EWDPLNGR) Special Glass  */ ~
                        #3,              /* (@BILSPC@) Optimizer Plann*/ ~
                        #4,              /* (@BILSP1@) Optimizer Other*/ ~
        ...
        dim glass_dte$8, glass_dte_fm$10,/* Production Date           */ ~
            ...
            rm_rec$(2%)192,              /* (APCPLNGR) Record (PAR000)*/ ~
        ...
        dim f2%(10%),                    /* = 0 if the file is open    */~
            ...
            ff$ = "@BILSPC@" : ff% = 3%   /* Created By Planning        */
            if sp_created$ = "1" then ff$ = "@BILSP1@" /* By Other      */
...
L01760:     err% = 4%
        ...
        write_batch_header           
            ...
            str(bat_hdr$,27%,20%) = file$      /* Entered in 'EWDPLN65' */
...
L02010:     cnt_ord% = cnt_ord% + 1%
            ...
            str(bat_order$,15%,2%) = "  "           /* Count Orders in */
            ...
            str(bat_order$,45%,2%) = "  "           /* Count Orders in */
...
L02710:     p1% = (220% - pp%) + 1%
        ...
        file_exists
          ...
          str(msg$(1%),18%,8%) = ff$
          msg$(2%) = "          B u i l d   B I L C O   G l a s s      "
...
L03510:    if cl$ = "A" then c% = 8%              /* Code 'A' = 'NO'   */
           ...
           lk$       = str(part$,12%,1%)          /* Lock Codes with   */
                                                  /* (PAR000)          */ 
                                                  /* 1 inch Grid Contour*/
           if str(sp_sub_part$,1%,1%) = "2" then lk% = 1%
           ...
           if gd$ = "00" then goto L03520
              if c% = 0% then goto L03520           /* Mod for New Grid  */
                 ...
                 if lk% <> 0% then color$ = "CONT" & c$(c%)
                                                  ...
                                                  /* (PAR000) 3/4"     */
                 if str(sp_sub_part$,2%,1%) = "2" then                  ~
                                                  color$ = "WIDE" & c$(c%)

L03520:    gs$ = "  "                             /* Argon Gas Flag    */
           gosub check_argon                    /* Check for Argon Gas */
           if argon% = 1% then gs$ = "G1"


           gosub check_krypton                   /* (AWD002)   */
