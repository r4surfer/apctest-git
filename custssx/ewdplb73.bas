        REM *************************************************************~
            ...
            *                                                           *~
            *-----------------------------------------------------------*~
            * EWDPLB73 - Generates the label format and data to print   *~
        ...
        sub "EWDPLB73" (type%,      /* type% = 0%-(Label), 1%-(Header) */~
        ...
        REM *************************************************************~
            ...
            *-----+----------+------------------------------------------*~
            * #5  ! MFLOWES  ! Print File For Production Labels         *~
            *************************************************************~
...
L61550:     error% = 5%
        ...
        load_label
           ...
           yy$(12%) = "01^FO140,1477^CI0^A0N,183,183^FR^FD"      /* (01)  */

           yy$(13%) = "02^FO412,1471^CI0^A0N,183,183^FR^FD"      /* (02)  */

           yy$(14%) = "29^FO616,1471^CI0^A0N,138,97^FR^FD"       /* (29)  */

           yy$(15%) = "^FO315,1697^CI0^A0N,183,183^FR^FDX^FS"

           yy$(16%) = "03^FO142,1932^CI0^A0N,183,183^FR^FD"      /* (03)  */

           yy$(17%) = "^FO234,1932^CI0^A0N,102,102^FR^FD'^FS"

           yy$(18%) = "04^FO431,1928^CI0^A0N,183,183^FR^FD"      /* (04)    */

           yy$(19%) = "29^FO616,1928^CI0^A0N,102,81^FR^FD"       /* (29)    */

           yy$(20%) = "05^FO957,1471^CI0^A0N,202,171^FR^FD"      /* (05)    */

           yy$(21%) = "^FO1034,1471^CI0^AFN,102,102^FR^FD'^FS"

           yy$(22%) = "06^FO1213,1471^CI0^A0N,202,171^FR^FD"     /* (06)    */

           yy$(23%) = "29^FO1396,1471^CI0^A0N,120,68^FR^FD"      /* (29)    */

           yy$(24%) = "^FO1128,1697^CI0^A0N,202,166^FR^FDX^FS"

           yy$(25%) = "07^FO957,1922^CI0^A0N,202,171^FR^FD"      /* (07)    */

           yy$(26%) = "^FO1051,1922^CI0^A0N,120,81^FR^FD'^FS"

           yy$(27%) = "08^FO1213,1922^CI0^A0N,202,171^FR^FD"     /* (08)    */

           yy$(28%) = "29^FO1388,1930^CI0^A0N,120,68^FR^FD"      /* (29)    */

           yy$(29%) = "^FO163,2601^CI0^A0N,183,183^FR^FDItem #^FS"

           yy$(30%) = "^FO955,2611^CI0^A0N,202,178^FR^FDItem #^FS"

           yy$(31%) = "13^FO276,2881^CI0^A0N,254,488^FR^FD"       /* (13)   */

           yy$(32%) = "14^FO268,3137^CI0^A0N,254,488^FR^FD"       /* (14)   */

           yy$(33%) = "15^FO252,3393^CI0^A0N,254,488^FR^FD"       /* (15)   */

           yy$(34%) = "16^FO248,3649^CI0^A0N,254,488^FR^FD"       /* (16)   */

           yy$(35%) = "18^FO1036,2849^CI0^A0N,273,467^FR^FD"      /* (18)   */

           yy$(36%) = "19^FO1040,3113^CI0^A0N,273,469^FR^FD"      /* (19)   */

           yy$(37%) = "20^FO1053,3377^CI0^A0N,273,468^FR^FD"      /* (20)   */

           yy$(38%) = "21^FO1057,3641^CI0^A0N,273,464^FR^FD"      /* (21)   */

           yy$(39%) = "22^FO1049,3903^CI0^A0N,273,476^FR^FD"      /* (22)   */

           yy$(40%) = "23^FO132,4552^CI0^A0N,102,81^FR^FD"        /* (23)   */

           yy$(41%) = "24^FO427,4552^CI0^A0N,102,81^FR^FD"        /* (24)   */

           yy$(42%) = "27^FO228,4665^CI0^A0N,102,102^FR^FD"       /* (27)   */

           yy$(43%) = "^FO203,1481^CI0^ADN,102,102^FR^FD'^FS"

           yy$(44%) = "17^FO252,3903^CI0^A0N,254,488^FR^FD"        /* (17)   */

           yy$(45%) = "30^FO1394,2154^CI0^A0N,152,81^FR^FD"        /* (30)   */

           yy$(46%) = "10^FO1231,2154^CI0^A0N,202,151^FR^FD"       /* (10)   */

           yy$(47%) = "31^FO1118,2154^CI0^A0N,120,76^FR^FD"        /* (31)   */

           yy$(48%) = "09^FO975,2154^CI0^A0N,202,151^FR^FD"        /* (09)   */

           yy$(49%) = "^FO927,2154^CI0^A0N,143,80^FR^FD(^FS"

           yy$(50%) = "30^FO610,2154^CI0^A0N,132,91^FR^FD"         /* (30)   */

           yy$(51%) = "12^FO459,2154^CI0^A0N,183,163^FR^FD"        /* (12)   */

           yy$(52%) = "31^FO337,2154^CI0^A0N,102,81^FR^FD"         /* (31)   */

           yy$(53%) = "11^FO183,2154^CI0^A0N,183,163^FR^FD"        /* (11)   */

           yy$(54%) = "^FO122,2154^CI0^A0N,142,132^FR^FD(^FS"

           yy$(55%) = "26^FO882,4552^CI0^A0N,102,81^FR^FD"         /* (26)   */

           yy$(56%) = "25^FO1174,4552^CI0^A0N,102,81^FR^FD"        /* (25)   */

           yy$(57%) = "28^FO975,4661^CI0^A0N,102,102^FR^FD"        /* (28)   */

                                                                   /* (EWD002) */
           yy$(58%) = "32^FO244,4176^CI0^A0N,254,488^FR^FD"        /* (32)  */

           yy$(59%) = "33^FO1036,4166^CI0^A0N,272,475^FR^FD"       /* (33)  */
                                                                     /* (EWD003) */
           yy$(60%) = "34^FO116,4208^BY3,2.0,102^BUB,102,Y,N,Y^FR^FD"

           yy$(61%) = "34^FO894,4216^BY3,2.0,102^BUB,102,Y,N,Y^FR^FD"
