        REM *************************************************************~
            ...
            *************************************************************
            ...
            sub "APCPLB40" (rpt%)        /* RPT% = 0% - SCREEN DSIPLAY */
                                         /*      = 1% - REPORT UTILITY */
        ...
        dim                              /* (Program) - Variables      */~
            ...
            h1$(5%)50, h2$(5%)50,        /* Screen/Report Headers      */~
            h3$(5%)40, h4$(5%)40,        /* Screen/Report Headers      */~
            h5$79, h6$(5%)40,            /* Screen/Report Headers      */~
        ...
        dim ad_key$33, ad_rec$64,        /* Audit Key and Record       */~
            ad_time$8, sd_key$22,        /* Scanned Time               */~
        ...
        REM *************************************************************~
          ...
          h1$(1%) = "New-Production Detail Screen'Not Scanned'-APCPLB40"
          h1$(2%) = "New-Stock Detail Screen 'Not Scanned'    -APCPLB40"
          h1$(3%) = "New-Production Detail Screen 'Scanned'   -APCPLB40"
          h1$(4%) = "New-Stock Detail Screen   'Scanned'      -APCPLB40"
          h1$(5%) = "New-Prod Detail (No Stock) 'Not Scanned' -APCPLB40"

          h2$(1%) = "New-Production Summary Screen'Not Scanned-APCPLB40"
          h2$(2%) = "New-Stock Summary Screen  'Not Scanned'  -APCPLB40"
          h2$(3%) = "New-Production Summary Screen  'Scanned' -APCPLB40"
          h2$(4%) = "New-Stock Summary Screen    'Scanned'    -APCPLB40"
          h2$(5%) = "New-Prod Summary (No Stock) 'Not Scanned'-APCPLB40"
...
*        Define the Input Message for the Screen/Field Indicated
        ...
        scrn1_msg  :  data                                               ~
         ...
         "Enter Rpt Select,1=Not Scan,2=Not Stock,3=Scan,4=StK,5=Not SO",~
...
L30260:     xx% = i%                              /* 1st Set Dept Value*/
            ...
            if dt_st$ > "11" then goto L30360    /* Not Scanned Values  */
...
L30355:        dt_st_d$ = "*Sched*"
               goto L30490                       /* Sashs, Parts By Dept*/
                                                /* Scanned Values      */
L30360:     ss_tot%(tt%) = ss_tot%(tt%) + 1%    /* Scanned Total       */
...
L30490:     if sc_dept$ = "ALL" then return         /* Totals Only     */
...
L50450:     sc_sel% = 1%
            ...
            if sc_sel% < 1% or sc_sel% > 5% then goto L50510
               sc_sel_d$ = sr$(sc_sel%)
        return
L50510:   errormsg$="(Error) - Invalid Report Selection? (1 thru 5)"
...
L61540:        FMT CH(24), CH(30)
            if str(readkey$,1%,9%) <> "PLAN DEPT" then                   ~
                                                  goto load_dept_done
            if str(readkey$,10%,1%) <> "0" then goto load_dept_done
               kk% = kk% + 1%
...
L62710: REM  CHECK SHIFT
           if sc_id$ = "AL" then goto L62750    /* Shift Not Specified */
...
L62920:    if p_scan% <> 0% then goto L62940     /* Goto Scanned Product*/
