...
*                 (PAR000)  01/15/2006 CR347         Dept (050)        *~
*                                                                      *~
...
*                                                                      *~
*                  New Flex Line Processing for 411 Line               *~
*                  ( As of 01/15/2006 - RHH  Dept 050 )                *~
*                                                                      *~
*        AWDPLA42 - Create File with Data for Saw Optimization         *~
*                   with Weld information also.                        *~
*                                                                      *~
*         Subs Replaced - EWDPLB42 (L), EWDPLA42 (W)                   *~ 
*                                                                      *~
*        (EWD028)                                                      *~                                          
*            File Layout                                               *~
*                 FR930318                                             *~
...
************************************************************************
        ...
        sub "AWDPLA42" (size%,           /* Batch Size (No. Windows)  */ ~
...
L03040:
        ...
        REM          convert ct(i%) to str(sa_cut$(sa%),1%,7%), pic(###.###)
               ...
               str(sa_part$(sa%),11%,5%) = "     "
                                                   /* Sash Equations   */
               if cut_type% <> 1% then go to L03250      
                  str(sa_part$(sa%),11%,1%) = "0"
                                                   /* Special Width Mod*/
                  if i% > cw% then goto L03260     /* Width Eq.        */
                     if lk$ = "1" then str(sa_part$(sa%),11%,1%) = "1"
                        goto L03260 
                                                   /* Frame Equations  */
L03250:        if cut_type% <> 2% then goto L03260 
                  str(sa_part$(sa%),11%,1%) = "0"
                                                   /* Special Height Mod*/
