...
*             New Subroutine for 200 Cont. Head and Seal  Dept (026)   *~
*             Models (773, 787, 775, 789, 777) - Triples               *~
*                    (772, 786, 774, 788, 776) = Twins                 *~
*                    (712, 713, 714, 715)                              *~
*                                                                      *~  
...
*                  ( As of 05/23/2006 - RHH  Dept 026 )                *~
*                                                                      *~
*        AWDPLO42 - Create File with Data for Saw Optimization         *~
...
************************************************************************
        ...
        sub "AWDPLO42" (size%,           /* Batch Size (No. Windows)  */ ~
...
L01410:   
        REM - Adjust Schedule
                                             /* (AWD036) - Special Note*/
            scr_prod$ = "7"                  /* For 200 Cont HD Series */
...
L02620:   errormsg$ = saw_err$(type%)
        ...
        if j% = 1% then goto L02630  
                                               ...
                                               /* for Triples (Sashes) */ 
          if model$ = "773" then str(bat_rec$,16%,4%) = "0002"
          if model$ = "775" then str(bat_rec$,16%,4%) = "0002"
          if model$ = "777" then str(bat_rec$,16%,4%) = "0002"
          if model$ = "787" then str(bat_rec$,16%,4%) = "0002"
          if model$ = "789" then str(bat_rec$,16%,4%) = "0002"
