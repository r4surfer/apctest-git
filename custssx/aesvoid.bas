        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *   AAA   EEEEE   SSSS  V   V   OOO   IIIII  DDDD           *~
            *  A   A  ER     S      V   V  O   O    I    D   D          *~
            *  AAAAA  EEE    SSSS   V   V  O   O    I    D   D          *~
            *  A   A  E          S   V V   O   O    I    D   D          *~
            *  A   A  EEEEE  SSSS     V     OOO   IIIII  DDDD           *~
            * -- <PF28> Overrides Restrictions for Admins           --  *~
            *-----------------------------------------------------------*~
            *                  M O D I F I C A T I O N S                *~
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 08/01/2006 ! Original copy of aesrcvsn              ! DES *~
            PRODUCTOFCAELUSASSOCIATESSPOKANEWASHINGTONALLRIGHTSRESERVED**


        sub "AESVOID"  (vendor$,         /* Vendor Code                */~
...
REM         call "OPENCHCK" (#2 , fs%(2), f2%(2), 300%, rslt$(2))
            ...
            init(hex(00)) vbk_key$
	    str(vbk_key$,1,9) = vendor$
	    str(vbk_key$,10,25) = po$
	    str(vbk_key$,26,28) = line$
