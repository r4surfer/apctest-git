        REM THISPROGRAMWASGENERATEDUSINGTHEGENPGMPROGRAMWHICHISAPROPRIETR~
            *                                                           *~
            *  PPPP   U   U  RRRR   PPPP   RRRR   IIIII  N   N  TTTTT   *~
            *  P   P  U   U  R   R  P   P  R   R    I    NN  N    T     *~
            *  PPPP   U   U  RRRR   PPPP   RRRR     I    N N N    T     *~
            *  P      U   U  R   R  P      R   R    I    N  NN    T     *~
            *  P       UUU   R   R  P      R   R  IIIII  N   N    T     *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * PURPRINT - Routine to aid in the printing of text.        *~
            *-----------------------------------------------------------*~
            *                  M O D I F I C A T I O N S                *~
            *---WHEN---+----------------WHAT----------------------+-WHO-*~
            * 06/13/00 ! ORIGINAL                                 ! CMG *~
            PRODUCTOFCAELUSASSOCIATESSPOKANEWASHINGTONALLRIGHTSRESERVED**

        sub "PURPRINT"   (#1, f201%,     /* TXTFILE channel and status */~
                          #2,            /* Work file for Faxing       */~
...
*        This routine prints the text
        ...
        return_from_caller_2
                str(a$,1%,printline%) = linemask$
                str(a$,horiz%, headmax%) = "** " & typedescr$
                gosub print_line
                line% = line% + 1%
...
L11310:     search srces$ = str(srce$,,3) to s%() step 3
        ...
        print_line
            write #2, using L20000, a$, hex(0D), eod goto L20010
L20000:    FMT CH(79), CH(1)
            a$ = all(hex(20))
        return
L20010:     a$ = all(hex(20))
        return clear all			
