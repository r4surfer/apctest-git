        REM *************************************************************~
            *                                                           *~
            *  IIIII  N   N  V   V   AAA   DDDD   JJJJJ   OOO   BBBB    *~
            *    I    NN  N  V   V  A   A  D   D    J    O   O  B   B   *~
            *    I    N N N  V   V  AAAAA  D   D    J    O   O  BBBB    *~
            *    I    N  NN   V V   A   A  D   D  J J    O   O  B   B   *~
            *  IIIII  N   N    V    A   A  DDDD    J      OOO   BBBB    *~
            *                                                           *~
            *-----------------------------------------------------------*~
            * INVADJOB - This sub looks to see if any inventory has     *~
            *            been moved 'from' a job back into inventory    *~
            *            by Inventory Additions. If inventory has been  *~
            *            moved from a job the INVQUAN onhand, total $   *~
            ...
            *          !   to PIPFLAGS.                           !     *~
            * 03/03/06 ! (PAR000) CR347 Mon for New Part Number   ! RHH *~
            *************************************************************

        sub "INVADJOB" (date$,           /* Current System Date        */~
                        hnydate$,        /* Inventory Posting Date     */~
                        #5,              /* INVADDTF record area       */~
                        #13,             /* PIPMASTR UFB               */~
                        #14)             /* SFCUM2   UFB               */
        ...
        REM *************************************************************~
            ...
            *************************************************************
            dim cms2v$50
            cms2v$ = "REV:01.01 03/03/06 No for New Part Number         "
        REM *************************************************************
...
*          Post inventory material to detail file
            ...
            totalcost = round(quantity*unitcost,4)
                                                       /* (PAR000) ???   */
            call "JMTAPOST" (jobnr$, str(part$,1%,25%), store$, lot$, date$, ~
...
L10270:          FMT XX(25), BI(4), XX(19), PD (14,4)
            ...
            if remquantity>0 then L10370
                                                       /* (PAR000)  ???  */
            delete #15
            call "PIPFLAGS" (str(part$,1%,25%),1%,indate%,-pipquantity,#13,#14)
