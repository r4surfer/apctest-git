        REM *************************************************************~
            ...
            *                                                           *~
            *-----------------------------------------------------------*~
            * EWDPLG72 - Generates the label format and data to print   *~
            ...
            *          !          not Applicable                  !     *~
            *12/09/2015! SR67154  Cloned from EWDPLC72 for new    ! PWW *~
            *          !          Larger Glass Label stock. 4 1/2 !     *~
            *          !          X 1 1/2 inches. Template is...  !     *~
            *          !          Glass Label G.btw.              !     *~
            *12/09/2015! SR73199  Changed lookup_sub_part to match! PWW *~
            *          !          ewdple72 & ewdplf72.            !     *~
        ...
        sub "EWDPLG72" (gl_rec$,         /* Entire EWDGLSXX Record     */~
...
SS_1:
            ...
            xx$(14%) = "^FT48,65^A0N,28,39^FDCLR:^FS"
                                                  /* Grid Color        */
            xx$(15%) = "15^FT136,65^A0N,28,39^FD"
            xx$(16%) = "^FT48,37^A0N,28,39^FDWND:^FS"
            xx$(17%) = "^FT340,65^A0N,28,39^FDGRID:^FS"
                                                  /* Grid Value          */ 
            xx$(18%) = "07^FT441,65^A0N,28,39^FD"
            xx$(19%) = "^FO595,6^GB20,30,20^FS"
                                                  /* Contour Grid        */
            xx$(20%) = "03^FT581,32^A0N,28,39^FR^FD"
            xx$(21%) = "^FT632,37^A0N,28,39^FDSEQ:^FS"
                                                  /* Prod Seq No.        */
            xx$(22%) = "02^FT708,39^A0N,31,42^FD"     /* CR2180 */
            xx$(23%) = "^FT48,91^A0N,28,39^FDWID:^FS"
                                                  /* Cut Width           */
            xx$(24%) = "14^FT137,89^A0N,28,41^FD"
            xx$(25%) = "^FT48,119^A0N,28,39^FDHGT:^FS"
                                                  /* Cut Height          */
            xx$(26%) = "13^FT137,119^A0N,28,39^FD"
            xx$(27%) = "^FO340,74^GB62,30,30^FS"
                                                  /* Top/Bot Descript    */
            xx$(28%) = "06^FT324,100^A0N,28,39^FR^FD"
            xx$(29%) = "^FO441,74^GB54,30,30^FS"
                                                  /* Dept code           */
            xx$(30%) = "05^FT425,100^A0N,28,39^FR^FD"
            xx$(31%) = "^FT48,151^A0N,28,39^FDDTE:^FS"
                                                  /* Production Date     */
            xx$(32%) = "12^FT136,151^A0N,28,39^FD"
            xx$(33%) = "^FT48,176^A0N,28,39^FDSO:^FS"
                                                  /* Sales Order         */
            xx$(34%) = "11^FT136,176^A0N,28,39^FD"
            xx$(35%) = "^FT340,138^A0N,28,39^FDMOD:^FS"
                                                  /* Model code          */
            xx$(36%) = "10^FT428,138^A0N,28,39^FD"
                                                  /* Glass Text          */
            xx$(37%) = "19^FT175,252^A0N,28,33^FD"      
                                                  /* Glass Description   */
            xx$(38%) = "20^FT175,278^A0N,28,39^FD"     
                                                        /* Glass Barcode */
/*SR73394   xx$(39%)= "01^FO627,114^BY2,2.0,87^BCN,87,N,N,N^FR^FD>;"     */
/*SR73394   xx$(39%)= "01^FO541,148^BY3^BCN,102,N,Y^FR^FD>:"             */
/* CR2180 */               
            if schema% = 2% then   ~  
/*SR7 6703*/ xx$(39%)= "25^FO568,102^BY2^BCN,102,N,Y^FR^FD>:.T.>5"  ~
            else    ~
             xx$(39%)= "01^FO555,102^BY2,2.5,87^BCN,102,N,N^FR^FD>;" 
                                                  /* Window Color        */
            xx$(40%) = "21^FT137,37^A0N,28,39"
                                                  /* Inside/Outside      */
            xx$(41%) = "22^FT428,37^A0N,28,39^FD"
            xx$(42%) = "^FT314,37^A0N,28,39^FDLOW E:^FS"
                                                  /* Human Barcode     */
            xx$(43%) = "01^FT593,88^A0N,28,39^FD"
            xx$(44%) = "^FT48,205^A0N,28,39^FDVT:^FS"
            xx$(45%) = "^FT48,231^A0N,28,39^FDHT:^FS"
                                                  /* Horizontal Text     */
            xx$(46%) = "18^FT136,231^A0N,28,39^FD"
                                                  /* Vertical Text       */ 
            xx$(47%) = "09^FT137,205^A0N,28,39^FD"
                                                  /* Glass Code        */
            xx$(48%) = "23^FT771,284^A0N,28,39^FD"
/* new bc*/
            if schema% = 2% or glchkbc$ = "0000" then goto nobarcode
REM            xx$(49%)= "24^FO390,203^BY2^BCN,51,N,N^FD>;"
            xx$(49%)= "24^FO48,241^BY2^BCN,51,N,N^FD>;"   
...
/*      glass_code$ = str(gl_rec$,45%,2%)                              */
        ...
        lbl$(22%)= txt_inside_outside$ & fs$
                                                  /* Glass Description   */ 
/*      glass_code$ = str(gl_rec$,45%,2%)                                */
/*      glass_code$ = str(rm_part$,5%,2%)                                */
/*      if glass_code$ = " " then glass_code$ = str(gl_rec$,45%,2%)      */
